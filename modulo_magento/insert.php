...
//  $msqlINSERT["$idPP"] = "INSERT INTO CreacionEncabezadoVenta ($campos) VALUES ('$valores'); ";
...
//  $msqlINSERTitem["$idPP"][] = "INSERT INTO CreacionItemsVentatmp ($campos) VALUES ('$valores'); ";
 $msqlINSERTitem["$idPP"][] = "INSERT INTO CreacionItemsVenta ($campos) VALUES ('$valores'); ";
 $campos =''; $valores='';
}
...
// mssql_query("DELETE FROM CreacionEncabezadoVenta ");
// mssql_query("DELETE FROM CreacionItemsVenta "); 
