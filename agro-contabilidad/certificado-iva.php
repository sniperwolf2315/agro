...
while( $row = odbc_fetch_array( $datos_cert_ibs ) ) {
    ...
    // echo " <br> -> $concepto <br>,$mes_cert <br>,$puc_cta_origen <br>,$valor_balace <br>";
        ...
        <table class="table table-light">
            <tr>
                <div class="parent">
                    ...
                    <br>
                    <div class="div-leyenda-2"><strong> CERTIFICADO DE RETENCION EN IVA</strong> </div>
                </div>
            <tr>
        ...
        foreach($find_count_puc as $data){
                ...
                if($mes <= $mes_act){
                        ...
                        while($dp = mssql_fetch_array($data_puc)){
                            ...
                            $base_gravable  = ceil($data[3]*1000 /  $dp['TARIFA']);
                            $mes            = $data[1] ;
                            $cta_puc        = $dp['CUENTA'] ;
