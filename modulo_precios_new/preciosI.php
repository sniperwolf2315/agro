...
<table class="abs"  width="100%" height="100%" bordercolor="silver" border="0" cellspacing="0">
    ...
    <tr>
    	<td height="43%"> </td>
    	<td>
			<iframe onload="setFocus()" id="iframe" name="iframe" class="hid" height="100%" width="100%" style="border:none" scrolling="no" src="preciosII.php"></iframe>
		</td>
    </tr>
	
	<!-- ES ES LA SECCION DEL LANDING -->
	<tr>
    	<td height="24%"></td>
    </tr>
