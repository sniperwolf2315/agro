...
*/
mssql_query( "delete from dbo.FACDETALLEFACTURANEW where $where_fechas_sia" );


$insert_detalle_fac = ("INSERT INTO [dbo].[FACDETALLEFACTURANEW]([Tipo],[Factura],[Fecha],[FechaOrden],[Cedula],[NombreCliente],[Bodega],[Vendedor],[DesVendedor],[Call],[Manejador],[Linea],[Item],[Descripcion],[FOC],[Grupo],[Segmento],[Familia],[Cantidad],[ValorSinIVA],[ValorIVA],[Valor],[Planeador],[Sector])VALUES " );
