...
//print_r("AQUI1: ".$arrall[1]);//$vendalm);
//print_r("AQUI2: ".$vendotro);
//print_r("AQUI3: ".$numvend);
//print_r('AQUI2: '.$arrall);
//echo $vendalm;
if($_POST['area'] == '' ){
  //$fnom = "'$_POST[vendedor]'";
  $flab="$labven";
...
//print_r($flabo);
//print_r("AQUI4: ".$fnom." AQUI 1: ".$fnom2);
if($_POST['cliente'] != '' ){
...
$sql = "SELECT
		...
		";
	$consultaVend="SELECT * FROM [sqlFacturas].[dbo].[cliVendedor] where codigo in ($fnom);";
	$queryv = mssql_query($consultaVend, $cLink);
	$numvend=mssql_num_rows($queryv);
	$nose=$fnom2;
	//print_r("AQUI4: ".$fnom." AQUI 1: ".$fnom2." nose: ".$numvend);
...
$result = odbc_exec($db2conp, $sql) ; //echo $sql; //echo odbc_errormsg();
	...
	// echo $_POST['area'].' == '.$_POST['queVer'].' == '.$_POST['desde'];
