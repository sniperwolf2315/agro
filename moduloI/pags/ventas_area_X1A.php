...
,sum( (CASE SRBISH.IHTYPP WHEN 1 THEN SRBISD.IDQTY ELSE SRBISD.IDQTY * -1 END)*
       ...
       * CASE WHEN substr(SRBPRG.PGDESC,1,3) ='KIT' THEN 0 ELSE 1 END   ) AS COSTO_ULTIMO                   	
FROM SROISH SRBISH
...
$sql = "SELECT 
		...
		WHERE
		 OHSTAT <> 'D'
			   AND SROORSHE.OHORDT NOT IN ('07','17','03','13','19','Z3','Z4','Z5','Z6','Z7','ZN','67','68','72','25','93','K4','ZM')
...
//VENTAS *CLIENTE se le quita PROD
$sql = "select 
...
$sql = "SELECT DISTINCT
            ...
            AND (SRBISD.IDORDT NOT IN ('07','17','03','13','19','Z3','Z4','Z5','Z6','Z7','ZN','67','68','72','25','93','K4'))
