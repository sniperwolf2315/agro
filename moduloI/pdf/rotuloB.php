...
if(date("Y-m-d") >= '2020-03-18' AND date("Y-m-d") <= '2020-03-21'){
  $mensajeIni ="<b><a>Espere pronto Agromania WEB ¡Solo en <u>www.agrocampo.com.co</u>!</a></b><br>";
  }elseif(date("Y-m-d") >= '2019-03-18' AND date("Y-m-d") <= '2019-03-21'){
  $mensajeIni ="<b><a>Estamos en AGROMANIA WEB, ¡<u>Solo en www.agrocampo.com.co!</u></a></b><br>";
  }
?>
<style type="text/css">
th, td, div {
...
<div class="hid" style="width:21.5cm; height:2.3cm">
<table class=" frm" style=" border: 0; page-break-after: always;" cellspacing="0" cellpadding="0">
	<tr>
		<th class="frxxs" style="width: 5.5cm; border: none;">
		</th>
		<td style="height: 2cm; width: 13.5cm" valign="top">
		  <?= $mensajeIni?>
		  Dir: <a class="<?= $tamaD?>"><b><?= $ti["DIR"]?></b></a>
		  <br>
		  <a class="<?= $tamaNCC?>"><b><?= $ti["CLI"]?></b></a> C.C. <a class="<?= $tamaNCC?>"><?= $ti["CC"]?></a> Cel : <a class="<?= $tamaNCC?>"><?= $ti["CEL"]?></a>
		  <br>
		  Obs: <?= substr($ti["OBS"],0,130)?> <a class="<?= $tamaF?>"><b><?= $meses["$hoyM"].$hoy?></b></a> Piezas <a class="<?= $tamaF?>"><b><?= $i?></b></a> de <a class="<?= $tamaF?>"><b><?= $_GET[cajas]?></b></a>
		...
		<? 
				...
				foreach($facs as $fac){
				$cont++;
				$facod["$cont"] ="<img height='100%' src='../../php-barcode/php/sample php/sample-gd.php?type=datamatrix&width=3.5&height=20&code=".trim($fac)."&angle=0&x=38&y=25&font=10' />";
				}
				?>
