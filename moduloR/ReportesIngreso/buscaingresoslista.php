...
$r=$r . "<tr style=\"border-bottom: 1pt solid black;\">";
   ...
   */
   ...
   if(file_exists($miruta)) { 
        ...
        $sql ="SELECT cc, ape1, ape2, nom1, nom2, sex, nto, temp, fecha, hora, sede FROM seg_ingreso WHERE (fecha BETWEEN '$fi' AND '$ff') $sede_a_tomar order by id DESC";
        ...
        //$ruta=$ruta."<td><a href='Informe/Informe_Ingreso.xlsx' class=\"z-depth-1 white-text text-darken-2\">Descargar</a><Strong></td>";
...
//$ruta="../moduloR/ReportesIngreso/".$mipath2;
$ruta=$ruta."<td><a href='".$mipath2."' class=\"z-depth-1 white-text text-darken-2\">Descargar</a><Strong></td>";
mysqli_close($result);
echo $ruta;
?>