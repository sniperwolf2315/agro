    ...
    <script language="JavaScript">
        ...
        function Solo_Numerico(variable) {
            ...
            function VerificarOrdenMagento() {
                ...
                var estad=document.getElementById('estd').value;
                var estad2=document.getElementById('estd2').value;
                if(sequence=="" && (dia=="Dia" || mes == "Mes" || dia=="" || mes == "")){
                    alert('Digite # pedido, o seleccione una fecha');
                    return false;
                }
                    document.getElementById('formu').innerHTML='<center><img class="responsive-img circle responsive-img center" src="img/radar.gif" width="180px" height="180px"></center>';
                    document.body.style.cursor = 'wait';
                    ...
                    // Realizar peticion HTTP
                    //peticion_http.open('POST', 'guardarvista.php?periodo=' + periodo + '&vista=' & vista, true);
                    peticion_http.open('POST', 'verifica_orden_magento.php?sq=' + sequence + '&di=' + dia + '&me=' + mes + '&an=' + anio + '&estd=' + estad + '&estd2=' + estad2, true);
                    peticion_http.send(null);
                    ...
                    <div class="row white center">
                        ...
                        <div class="row center blue lighten-3">
                            ...
                            <div class="col s12 m7 l6 xl12 blue lighten-2 white-text">
                             <div class="flow-text" style="font-size:1.2em;text-align:center;">
                                 <span style="color: #000000;size:1.2em;">VERIFICAR CARGUE DE ORDENES A IBS</span>
                             </div>
                          ...
                          <div style="width: 100%; background-color: #024C68;">
                                    <label style="color: White; font-size: 1em;">Lista de Ordenes </label>
                                    <!--<label style="color: White; font-size: 0.6em;"></label>-->
                                    <center><table style="width: 50%;">
                                    <tr>
                                    <td style="text-align: center;">
                                    Diafin<select id="dd" class="browser-default light-blue-text" style="width: 60px; height: 25px; font-size: 0.8em;">
                                        <option value="" disabled selected>D&iacute;a </option>
                                        <?php
                                        $dia=1;
                                        while($dia<=31){
                                  ...
                                  <td style="text-align: center;">
                                  Mes<select id="mm" class="browser-default light-blue-text" style="width: 60px; height: 25px; font-size: 0.8em;">
                                  ...
                                  <td>
                                  A&ntilde;o<select id="yy" class="browser-default light-blue-text" style="width: 80px; height: 25px; font-size: 0.8em;">
                                        <?php
                                        $anio=date("Y");
                                  ...
                                  <td>
                                  Estado1<select id="estd" class="browser-default light-blue-text" style="width: 80px; height: 25px; font-size: 0.8em;">
                                  ...
                                  <td>
                                  Estado2<select id="estd2" class="browser-default light-blue-text" style="width: 80px; height: 25px; font-size: 0.8em;">
                                        <option value="processing">processing</option>
                                        <option value="ondelivery">ondelivery</option>
                                        <option value="pending">pending</option>
                                        <option value="canceled">canceled</option>
                          ...
                          <br />
                                    ...
                                    <input type="submit" id="OrdFal" onclick="VerificarOrdenIBSLista();" class="waves-efect waves-light btn" name="Enviar2" value="Ordenes Pendientes de Subir a IBS" /><br /><br />
