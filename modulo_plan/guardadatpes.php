                ...
                if($largo<5){
                    if($dp!='Ninguno'){
                        if($emp=='AG'){
                            ...
                            $consulta3= "UPDATE zAgroPremiosPestar2021 SET Firma='$firma', PremioCompras='$Premio', FirmaVendedor='$urlcliente', Premio1='$Premio1', Premio2='$Premio2', Premio3='$Premio3', Premio4='$Premio4', Premio5='$Premio5' WHERE Cedula='$d1' and Estado='0'";
                            $resultado2=mssql_query($consulta3);
                            $pelegido=utf8_encode($pelegido);
                            ...
                            $consulta2=$consulta2." VALUES('$nom','$m2018','$c2018','$avance','$montoc','$firma','$fechareg','$nomest','$d1','$d8','$dpto','$ciud','$d4','$d5','$d6b','$d7','1','$cate','$Premio','$urlcliente','$codv','$tipo','$md','$emp','$pelegido','$url','-','','','','$Premio1','$Premio2','$Premio3','','','$montodos','$Premio4','$Premio5')";
                            $resultado1=mssql_query($consulta2); 
                        }
                    ...
                    //$resultado=$mysqli->query($consulta);
                        if($resultado1){
                            echo("Datos Plan 2021 fueron procesados.");
                        }else{
