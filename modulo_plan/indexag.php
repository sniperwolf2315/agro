...
<html lang="en">
    <head>
        ...
        <title>FORMULARIO PLAN A&Ntilde;O 2023</title>
        <script language="JavaScript">
            ...
            function guardarDatos(empr) {
                ...
                peticion_http.open('POST', 'guardadat.php?d1=' + d1 + '&d2=' + d2 + '&d3=' + d3 + '&d4=' + d4 + '&d5=' + d5 + '&d6=' + d6 + '&d6b=' + d6b + '&d7=' + d7 + '&d8=' + d8 + '&d9=' + d9 + '&d10=' + d10 + '&d11=' + d11 + '&d12=' + d12 + '&df=' + df + '&dp=' + dp + '&md=' + md + '&tp=' + tpp + '&pe=' + pe + '&emp=' + empr + '&txtImg=' + txtImg + '&cond=' + cond, true);
                peticion_http.send(null);
    ...
    <body style="background-color: #E4EAC0;">
     //  <?php
    //  echo "<br /><br /><p><center><STRONG>El Plan año 2023 se encuentra CERRADO. Gracias por su visita!. Los esperamos pronto. </STRONG></p></center>";
        ...
        <div class="centrarancho">
            ...
            <form id="formCanvas" name="formCanvas" method="POST" ENCTYPE="multipart/form-data" action="">
                ...
                <tr><td style="width: 10%">&nbsp;</td>
                    ...
                    <ol>
                    <li><label class="parrafo">Concurso valido por compras antes de IVA desde enero 1 hasta el 23 de diciembre 2023.</label></li> 
                    <li><label class="parrafo">Válido únicamente por compras de medicamentos y productos importados directamente por Agrocampo (Consulte a su asesor).</label></li> 
                    <li><label class="parrafo">Sólo se entregará (1) un premio, de las alternativas en cada escala asignada.</label></li>  
                    <li><label class="parrafo">Los premios son únicamente los relacionados en el Plan Año 2023.</label></li>  
                    <li><label class="parrafo">Plazo máximo para la firma del negocio es abril 15 de 2023.</label></li> 
                    <li><label class="parrafo">La entrega del premio se hará máximo el 30 de abril de 2024.</label></li>  
                    <li><label class="parrafo">Para la entrega del premio, el cliente debe tener un adecuado manejo del crédito y estar al día en su cartera.</label></li> 
                    <li><label class="parrafo">Los fletes del premio deben ser asumidos por el ganador</label>  
                    <li><label class="parrafo">Ningún premio es transferible, ni canjeable por dinero o especie.</label></li>  
                    <li><label class="parrafo">Los premios pueden ser susceptibles a cambios según la disponibilidad de referencias, pero siempre serán iguales o superiores <br /> a los especificados en este acuerdo y de marcas reconocidas.</label></li>
                    ...
                    <li><label class="parrafo">No incluye trámite de visas en los destinos que lo requieran.</label></li>
                    <li><label class="parrafo">Los viajes son para el titular de la cuenta con Agrocampo y son intransferibles.</label></li> 
                    <li><label class="parrafo">Los viajes son redimibles únicamente en temporada baja y durante el 2024. No incluye puentes ni festivos. La fecha debe ser acordada con mínimo 3 meses de anticipación, la cual no debe ser cambiada debido a los altos costos que implica</label></li>
                    <li><label class="parrafo">Se le enviara por correo electrónico copia de este acuerdo como soporte del PLAN AÑO 2023, por favor imprímala y consérvela.</label></li>
                    <br />METODOLOGÍA NOTA CRÉDITO:<br />
                    </ol>
                    <ol>
                    <li><label class="parrafo">El premio que se genera a través de la nota crédito tomará como base para su liquidación las compras realizadas del 1 de enero al 23 de diciembre de 2023 antes de IVA.<br /> Válido únicamente por compras de medicamentos y productos importados directamente por Agrocampo.</label></li> 
                    <li><label class="parrafo">Para el descuento de la nota del 3% el cliente deberá tener en cuenta lo siguiente:</label></li> 
                        <ol type="a">
                        <li><label class="parrafo">a. Las compras deben ser de enero 1 hasta el 23 de diciembre 2023.</label></li>
                        <li><label class="parrafo">b. Las facturas emitidas en el periodo antes mencionado deben estar plenamente canceladas.</label></li>
                        <li><label class="parrafo">c. Una vez verificada la información de los puntos a. y b. se emitirá al cliente la nota correspondiente y se remitirá vía correo electrónico.</label></li> 
                        <li><label class="parrafo">d. Tras recibir la nota crédito, el cliente deberá manifestarnos por escrito a qué facturas se aplicará.</label></li>
                        </ol>
                    </ol>
                    <li><label class="parrafo">La presente “METODOLOGÍA PLAN AÑO” deberá interpretarse sistemáticamente con nuestros Términos y Condiciones Generales Promocionales y Descuentos AGROCAMPO S.A.S. <br> Política de la Tienda,  Política de Datos, Estatuto del Consumidor y Política de Responsabilidad Social En:<br> https://www.agrocampo.com.co </label></li>
                        <br>
                        <br>
                </div>
                    <? 
                    ...
                    <br />CONOCIENDO Y ACEPTANDO LAS SIGUIENTES CONDICIONES:<br />
                    <ol>
                    <li><label class="parrafo">Concurso valido desde enero 1 de 2023 hasta el 21 de diciembre de 2023.</label></li> 
                    <li><label class="parrafo">V&aacute;lido &uacute;nicamente por compras de medicamentos de Pestar.</label></li> 
                    <li><label class="parrafo">La fecha l&iacute;mite para la entrega de premios ser&aacute; marzo de 2023.</label></li>
