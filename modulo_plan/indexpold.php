...
///echo "El Plan año 2020 de AGROCAMPO se encuentra cerrado, Gracias por su visita!";
//exit();
...
<html lang="en">
    <head>
        ...
        <script language="JavaScript">
            ...
            function manejoDatospersonales(estado){
                ...
                var texto='<br />';
                    texto=texto + '<label class="parrafofin">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CONSENTIMIENTO PARA TRATAMIENTO DE DATOS PERSONALES <BR /><BR /> ';
                    texto=texto + 'De acuerdo con la Ley Estatutaria 1581 de 2012 de Protección de Datos y normas concordantes, ';
                    ...
                    texto=texto + 'a la Calle 73 # 20-62</label><BR />'
                        ...
                        if (peticion_http.status == 200) {
                            ...
                            if (dato.length <= 23) {
                                ...
                                if(datos[12].length > 3){
                                    alert("Usted ya registro el plan año 2020.");
                                    ...
                                    if(empresa=='X1'){
                                        if(parseInt(monto2)==0){
                                            ...
                                            //explicacion de premios inferior
                                            descripcionPremios(p1,p2,p3);
                                            
                                            consultarPorcentajes2(p4,p5);
                                            //explicacion de los premios
                                            descripcionPremios2(p4,p5);
                                            //descripcionPremios(p1,p2,p3);
                                            //valores
                                            document.getElementById('T11').value = '$ ' + datos[9];
                                            document.getElementById('T11b').value = '$ ' + datos[18];
                                        }
                                    }else if(empresa=='AG'){
                                        document.getElementById('T11').value = '$ ' + datos[9];
                                        consultarPremios();
            ...
            function cargaPremios1(){
                var texto='';
                texto='<table><tr>';
                texto=texto + '<td>&nbsp;</td>';
                texto=texto + '<td><label style="font-size: 14pt" class="etiqueta1">OBJETIVO DE COMPRAS 2020</label></td>';
                texto=texto + '<td>';
                     texto=texto +  '<input type="text" ID="T11" name="T11" maxlength="11" class="texto1" style="text-align: right; width: 100px;" readonly="true" />';
                   texto=texto + '</td>';
                texto=texto + '</tr>';
                texto=texto + '<tr><td colspan="3">&nbsp;</td></tr>';
                texto=texto + '<tr>';
                   texto=texto + '<td>&nbsp;</td>';
                   texto=texto + '<td style="vertical-align: top;"><label style="font-size: 14pt" class="etiqueta1">Premios</label></td>';
                   texto=texto + '<td>'; 
                   texto=texto + '<textarea id="Premio" name="Premio" rows="1" placeholder="campo obligatorio" class="texto2" readonly="true" style="visibility: hidden;"></textarea>';
                   texto=texto + '</td>';
                texto=texto + '</tr>';
                texto=texto + '<tr><td colspan="3">&nbsp;</td></tr>';
                texto=texto + '<tr>';
                    texto=texto + '<td>&nbsp;</td>';
                   texto=texto + '<td colspan="2">';
                   texto=texto + '<div id="fotosp1" style="text-align: center; float: left;"></div><br />';
                   texto=texto + '<div id="fotosp2" style="text-align: center; float: left;"></div><br />';
                   texto=texto + '<div id="fotosp3" style="text-align: center; float: left;"></div><br />';
                   texto=texto + '</td>';
                texto=texto + '</tr></table>';
                document.getElementById('verpremios').innerHTML=texto;
            }
            
            function cargaPremios2(){
                var texto='';
                var texto2='';
                texto='<table><tr>';
                texto=texto + '<td>&nbsp;</td>';
                texto=texto + '<td><label style="font-size: 14pt" class="etiqueta1">1° OBJETIVO DE COMPRAS 2020</label></td>';
                texto=texto + '<td>';
                     texto=texto +  '<input type="text" ID="T11" name="T11" maxlength="11" class="texto1" style="text-align: right; width: 150px;" readonly="true" />';
                   texto=texto + '</td>';
                texto=texto + '</tr>';
                texto=texto + '<tr><td colspan="3">&nbsp;</td></tr>';
                texto=texto + '<tr>';
                ...
                //ambos precios
                texto2='<br /><br /><table><tr>';
                texto2=texto2 + '<td>&nbsp;</td>';
                texto2=texto2 + '<td><label style="font-size: 14pt" class="etiqueta1">2° OBJETIVO DE COMPRAS 2020</label></td>';
                texto2=texto2 + '<td>';
                     texto2=texto2 +  '<input type="text" ID="T11b" name="T11b" maxlength="11" class="texto1" style="text-align: right; width: 150px;" readonly="true" />';
                   texto2=texto2 + '</td>';
                texto2=texto2 + '</tr>';
                texto2=texto2 + '<tr><td colspan="3">&nbsp;</td></tr>';
                texto2=texto2 + '<tr>';
                   texto2=texto2 + '<td>&nbsp;</td>';
                   texto2=texto2 + '<td style="vertical-align: top;"><label style="font-size: 14pt" class="etiqueta1">Premios</label></td>';
                   texto2=texto2 + '<td>'; 
                   texto2=texto2 + '<textarea id="Premio2" name="Premio2" rows="1" placeholder="campo obligatorio" class="texto2" readonly="true" style="visibility: hidden;"></textarea>';
                   texto2=texto2 + '</td>';
                texto2=texto2 + '</tr>';
                texto2=texto2 + '<tr><td colspan="3">&nbsp;</td></tr>';
                texto2=texto2 + '<tr>';
                    texto2=texto2 + '<td>&nbsp;</td>';
                   texto2=texto2 + '<td colspan="2">';
                   texto2=texto2 + '<div id="fotosp4" style="text-align: center; float: left;"></div><br />';
                   texto2=texto2 + '<div id="fotosp5" style="text-align: center; float: left;"></div><br />';
                   //texto2=texto2 + '<div id="fotosp3" style="text-align: center; float: left;"></div><br />';
                   texto2=texto2 + '</td>';
                texto2=texto2 + '</tr></table><br /><br />';
                
                document.getElementById('verpremios').innerHTML=texto+texto2;
            }
            ...
            function descripcionPremios(p1,p2,p3){
                ...
                //alert(x3);
                if(x3==-1){
                descripcion=descripcion + '<li><label class="parrafo">Incentivos vendedores: Bonos del ' + p3 + ' sobre las compras despu&eacute;s de descuentos, que se liquidar&aacute;n semestralmente y proporcional al cumplimiento del negocio a&ntilde;o para que se entregue a los vendedores de mostrador y externos por cumplimiento de ventas, para esto se debe entregar relaci&oacute;n firmada con valor por vendedor que recibi&oacute; el incentivo.<br /> Esta nota podr&aacute; ser cambiada por bonos Sodexo Pass, previa autorizaci&oacute;n del representante legal.</label></li>';
                }
                descripcion=descripcion + '</ol>';
                document.getElementById('descripremios').innerHTML=descripcion;
            }
            
            function descripcionPremios2(p4,p5){
                var descripcion='';
                var x1='';
                var x2='';
                descripcion='<ol>';
                x1=p4.indexOf("0%");
                if(x1==-1){
                descripcion=descripcion + '<li><label class="parrafo">Premio a&ntilde;o para la empresa en mercanc&iacute;a al final del a&ntilde;o comercial del ' + p4 + ' del total de las compras despu&eacute;s de descuentos.</label></li>';
                }
                x2=p5.indexOf("0%");
                if(x2==-1){
                descripcion=descripcion + '<li><label class="parrafo">Premio a&ntilde;o para la empresa en Nota Cr&eacute;dito al final de a&ntilde;o comercial del ' + p5 + ' del total de las compras despu&eacute;s de descuentos.</label></li>';
                }
                /*x=p3.indexOf("0%");
                if(x==-1){
                descripcion=descripcion + '<li><label class="parrafo">Incentivos vendedores: Bonos del ' + p3 + ' sobre las compras despu&eacute;s de descuentos, que se liquidar&aacute;n semestralmente y proporcional al cumplimiento del negocio a&ntilde;o para que se entregue a los vendedores de mostrador y externos por cumplimiento de ventas, para esto se debe entregar relaci&oacute;n firmada con valor por vendedor que recibi&oacute; el incentivo.<br /> Esta nota podr&aacute; ser cambiada por bonos Sodexo Pass, previa autorizaci&oacute;n del representante legal.</label></li>';
                ...
                descripcion=descripcion + '</ol>';
                document.getElementById('descripremios2').innerHTML=descripcion;
            }
            ...
            function consultarPorcentajes(p1,p2,p3){
                ...
                //if(d1=='1' && parar=='0'){
                   ...
                   // alert(x);
                    ...
                    if(x3==-1){
                        ...
                        imagen=imagen+"<div class=\"fondopre\"><table style=\"border: 1;width: 98%;\"><tr><td style=\"width: 50%;\">Incentivos vendedores: Bonos del "+p3+" sobre las compras después de descuentos.</td>";
                        ...
                        premio3=premio+"Incentivos vendedores: Bonos sobre compras del " + p3;
                    }
                ...
                //alert(premio1.length);
                //alert(premio1);
                if(premio1.length>5 && premio2.length>5 && premio3.length>5){
                    premio=premio1 + '; ' + premio2 + '; ' + premio3;
                } else if(premio1.length>5 && premio2.length>5 && premio3.length<=0){
                    premio=premio1 + '; ' + premio2;
                }else if(premio1.length>5 && premio2.length<=0 && premio3.length>5){
                    premio=premio1 + '; ' + premio3;
                }else if(premio1.length<=0 && premio2.length>5 && premio3.length>5){
                    premio=premio2 + '; ' + premio3;
                }else if(premio1.length>5 && premio2.length<=0 && premio3.length<=0){
                    premio=premio1;
                }else if(premio1.length<=0 && premio2.length>5 && premio3.length<=0){
                    premio=premio2;
                }else if(premio1.length<=0 && premio2.length<=0 && premio3.length>0){
                    premio=premio3;
                }
            ...
            function consultarPorcentajes2(p4,p5){
                //var d1 = document.getElementById('Categoria').value;
                var imagen='';
                var parar=0;
                var mas='';
                ...
                //if(d1=='1' && parar=='0'){
                    ...
                    if(x1==-1){
                        parar=1;
                        imagen="<table><tr><td></td></tr></table>";
                        imagen=imagen+"<div class=\"fondopre\"><table style=\"border: 1;width: 98%;\"><tr><td style=\"width: 50%;\">Premio a&ntilde;o para la empresa en Nota Cr&eacute;dito al final de año comercial del "+p4+" del total de las compras despu&eacute;s de descuentos.</td>";
                        //imagen=imagen+"<td style=\"width: 50%;background-color: #FFFFFF; text-align: center;\"><BR /><img src=\"FOTOSPLAN/1/Multifuncional.png\" alt=\"premio\" /><BR /></td><td style=\"padding: 5px;\"><label class=\"parrafo\"> Scanea, imprime y copia, velocidad de Impresión: 20 ppm, resolución impresión: 1200 x 1200 dpi, resolución escaner: 4800 x 4800, conectividad: wifi.</label></td></tr></table>";
                        //imagen=imagen+"<td style=\"width: 50%;background-color: #FFFFFF; text-align: center;\"><BR /><input type=\"radio\" name=\"2\" value=\"Incentivos vendedores: Bonos o mercancía sobre compras\" id=\"PremioIncentivosBonosMercancia\" style=\"width: 20px;\" onclick=\"seleccionarFoto(this.value,this.id);\">SELECCIONAR<br /><br /></td></tr></table>";
                        imagen=imagen+"</tr></table></div>";
                        ...
                        //premio=premio+" + Incentivos vendedores: Bonos o mercancía sobre compras del " + p1;
                        premio4=premio+"Premio año para la empresa en Nota Crédito del " + p4;
                    }
                    //imagen 3
                    x2=p5.indexOf("0%");
                    imagen='';
                    ...
                    if(x2==-1){
                        ...
                        imagen=imagen+"<div class=\"fondopre\"><table style=\"border: 1;width: 98%;\"><tr><td style=\"width: 50%;\">Incentivos vendedores: Bonos del "+p5+" sobre las compras después de descuentos.</td>";
                        //imagen=imagen+"<td style=\"width: 50%;background-color: #FFFFFF; text-align: center;\"><BR /><img src=\"FOTOSPLAN/1/Multifuncional.png\" alt=\"premio\" /><BR /></td><td style=\"padding: 5px;\"><label class=\"parrafo\"> Scanea, imprime y copia, velocidad de Impresión: 20 ppm, resolución impresión: 1200 x 1200 dpi, resolución escaner: 4800 x 4800, conectividad: wifi.</label></td></tr></table>";
                        //imagen=imagen+"<td style=\"width: 50%;background-color: #FFFFFF; text-align: center;\"><BR /><input type=\"radio\" name=\"2\" value=\"Incentivos vendedores: Bonos o mercancía sobre compras\" id=\"PremioIncentivosBonosMercancia\" style=\"width: 20px;\" onclick=\"seleccionarFoto(this.value,this.id);\">SELECCIONAR<br /><br /></td></tr></table>";
                        imagen=imagen+"</tr></table></div>";
                        ...
                        //premio=premio+" + Incentivos vendedores: Bonos o mercancía sobre compras del " + p1;
                        premio5=premio+"Incentivos vendedores: Bonos sobre compras del " + p5;
                    }
                    //document.getElementById('fotosp5').innerHTML = "<BR /><center><HR /><B><input type=\"radio\" name=\"2\" value=\"NOTA CREDITO 3%\" style=\"width: 20px;\" id=\"NOTA CREDITO 3\" onclick=\"seleccionarFoto(this.value,this.id);\">NOTA CR&Eacute;DITO 3%</B></center>";
                //}
                //document.getElementById('p1').textContent=p1;
                ...
                //descripcion del premio
                if(premio4.length>5 && premio5.length>5){
                    premio=premio4 + '; ' + premio5;
                }else if(premio4.length>5 && premio5.length<=0){
                    premio=premio4;
                }else if(premio4.length<=0 && premio5.length>5){
                    premio=premio5;
                }
                
                //premio=premio1 + ' + ' + premio2 + ' + ' + premio3;
                document.getElementById('Premio2').value=premio;
                document.getElementById('premioelegido2').value=premio;
            }
            ...
            function consultarPremios(){
                ...
                if(d1=='1' && parar=='0'){
                    ...
                    imagen=imagen+"<input type=\"radio\" name=\"2\" value=\"VIAJE 2 TIQUETE AÉREO BOGOTÁ CARTAGENA BOGOTÁ\" id=\"Viaje\" style=\"width: 20px;\" onclick=\"seleccionarFoto(this.value,this.id);\">SELECCIONAR<br />";
                    imagen=imagen+"</div><hr />";
                    document.getElementById('fotosp4').innerHTML = imagen;
                    //nota credito
                    ...
                    imagen=imagen+"<input type=\"radio\" name=\"2\" value=\"VIAJE QUINDÍO, DECAMERON PANACA  2 NOCHES 3 DÍAS PARA 2 PERSONAS SIN TIQUETES\" id=\"Quindio\" style=\"width: 20px;\" onclick=\"seleccionarFoto(this.value,this.id);\">SELECCIONAR<br />";
                    imagen=imagen+"</div><hr />";
                    ...
                    imagen=imagen+"<input type=\"radio\" name=\"2\" value=\"Portátil 14\" id=\"Portatil 14\" style=\"width: 20px;\" onclick=\"seleccionarFoto(this.value,this.id);\">SELECCIONAR<br />";
                    imagen=imagen+"</div><hr />";
                    ...
                    imagen=imagen+"<input type=\"radio\" name=\"2\" value=\"Patineta Eléctrica-Scooter.\" id=\"Patineta\" style=\"width: 20px;\" onclick=\"seleccionarFoto(this.value,this.id);\">SELECCIONAR<br />";
                    imagen=imagen+"</div><hr />";
                    document.getElementById('fotosp3').innerHTML = imagen; //ok
                    //imagen 4
                    ...
                    imagen=imagen+"<input type=\"radio\" name=\"2\" value=\"VIAJE CALI 3 NOCHES 4 DÍAS EN FIN DE SEMANA HOTEL 4 ESTRELLAS\" id=\"Cali\" style=\"width: 20px;\" onclick=\"seleccionarFoto(this.value,this.id);\">SELECCIONAR<br />";
                    imagen=imagen+"</div><hr />";
                    document.getElementById('fotosp4').innerHTML = imagen; //ok
                    //nota credito
                    imagen="<div class=\"fondopre\"><table style=\"border: 1;width: 98%;\"><tr><td style=\"width: 20%;\">NOTA CR&Eacute;DITO 3%</td>";
                    ...
                    imagen=imagen+"<input type=\"radio\" name=\"2\" value=\"VIAJE PALOMINO 4 NOCHES 5 DÍAS\" id=\"Palomino\" style=\"width: 20px;\" onclick=\"seleccionarFoto(this.value,this.id);\">SELECCIONAR<br />";
                    imagen=imagen+"</div><hr />";
                    document.getElementById('fotosp4').innerHTML = imagen; //OK
                    //nota credito
                    ...
                    imagen=imagen+"<input type=\"radio\" name=\"2\" value=\"VIAJE SANTA MARTA 2 NOCHES 3 DÍAS CON TIQUETES DESDE BOGOTÁ\" id=\"Santamarta\" style=\"width: 20px;\" onclick=\"seleccionarFoto(this.value,this.id);\">SELECCIONAR<br />";
                    imagen=imagen+"</div><hr />";
                    document.getElementById('fotosp4').innerHTML = imagen; //ok
                    //nota credito
                    ...
                    imagen=imagen+"<input type=\"radio\" name=\"2\" value=\"VIAJE CARTAGENA 3 NOCHES 4 DÍAS CON TIQUETES. REF\" id=\"Cartagena\" style=\"width: 20px;\" onclick=\"seleccionarFoto(this.value,this.id);\">SELECCIONAR<br />";
                    imagen=imagen+"</div><hr />";
                    document.getElementById('fotosp4').innerHTML = imagen; //OK
                    //nota credito
                    imagen="<div class=\"fondopre\"><table style=\"border: 1;width: 98%;\"><tr><td style=\"width: 20%;\">NOTA CR&Eacute;DITO</td>";
                    ...
                    imagen=imagen+"<input type=\"radio\" name=\"2\" value=\"VIAJE GUAJIRA 3 NOCHES 4 DÍAS PARA 2 PERSONAS\" id=\"Guajira\" style=\"width: 20px;\" onclick=\"seleccionarFoto(this.value,this.id);\">SELECCIONAR<br />";
                    imagen=imagen+"</div><hr />";
                    document.getElementById('fotosp4').innerHTML = imagen; //ok
                    //nota credito
                    imagen="<div class=\"fondopre\"><table style=\"border: 1;width: 98%;\"><tr><td style=\"width: 20%;\">NOTA CR&Eacute;DITO</td>";
                    ...
                    imagen=imagen+"<input type=\"radio\" name=\"2\" value=\"2 GUADAÑADORA SHINDAIWA B 45 6 ACCESORIOS\" id=\"Guadanas\" style=\"width: 20px;\" onclick=\"seleccionarFoto(this.value,this.id);\">SELECCIONAR<br />";
                    imagen=imagen+"</div><hr />";
                    document.getElementById('fotosp2').innerHTML = imagen; //ok
                    //imagen 3
                    ...
                    imagen=imagen+"<input type=\"radio\" name=\"2\" value=\"VIAJE SANTA MARTA HOTEL IROTAMA  3 NOCHES 4 DÍAS\" id=\"Santamartairotama\" style=\"width: 20px;\" onclick=\"seleccionarFoto(this.value,this.id);\">SELECCIONAR<br />";
                    imagen=imagen+"</div><hr />";
                    document.getElementById('fotosp4').innerHTML = imagen; //OK
                    //nota credito
                    imagen="<div class=\"fondopre\"><table style=\"border: 1;width: 98%;\"><tr><td style=\"width: 20%;\">NOTA CR&Eacute;DITO</td>";
                    ...
                    imagen=imagen+"<input type=\"radio\" name=\"2\" value=\"VIAJE LETICIA, AMAZONAS 3 NOCHES 4 DÍAS\" id=\"Leticia\" style=\"width: 20px;\" onclick=\"seleccionarFoto(this.value,this.id);\">SELECCIONAR<br />";
                    imagen=imagen+"</div><hr />";
                    document.getElementById('fotosp4').innerHTML = imagen; //OK
                    //nota credito
                    imagen="<div class=\"fondopre\"><table style=\"border: 1;width: 98%;\"><tr><td style=\"width: 20%;\">NOTA CR&Eacute;DITO</td>";
                    ...
                    imagen=imagen+"<input type=\"radio\" name=\"2\" value=\"VIAJE SAN ANDRES  3 NOCHES 4  DÍAS\" id=\"Sanandres\" style=\"width: 20px;\" onclick=\"seleccionarFoto(this.value,this.id);\">SELECCIONAR<br />";
                    imagen=imagen+"</div><hr />";
                    document.getElementById('fotosp3').innerHTML = imagen; //ok
                    //imagen 4
                    /*imagen="<div class=\"fondopre\"><table style=\"border: 1;width: 98%;\"><tr><td style=\"width: 20%;\">2 TIQUETE AÉREO BOGOTÁ CARTAGENA BOGOTÁ</td>";
                    ...
                    imagen=imagen+"<input type=\"radio\" name=\"2\" value=\"2 TIQUETE AÉREO BOGOTÁ CARTAGENA BOGOTÁ\" id=\"Viaje\" style=\"width: 20px;\" onclick=\"seleccionarFoto(this.value,this.id);\">SELECCIONAR<br />";
                    imagen=imagen+"</div><hr />";
                    document.getElementById('fotosp4').innerHTML = imagen;*/
                    //nota credito
                    ...
                    imagen=imagen+"<input type=\"radio\" name=\"2\" value=\"VIAJE LETICIA, AMAZONAS 4 NOCHES 5 DÍAS PARA 3 PERSONAS\" id=\"Leticia\" style=\"width: 20px;\" onclick=\"seleccionarFoto(this.value,this.id);\">SELECCIONAR<br />";
                    imagen=imagen+"</div><hr />";
                    document.getElementById('fotosp3').innerHTML = imagen; //ok
                    //imagen 4
                    /*imagen="<div class=\"fondopre\"><table style=\"border: 1;width: 98%;\"><tr><td style=\"width: 20%;\">2 TIQUETE AÉREO BOGOTÁ CARTAGENA BOGOTÁ</td>";
                    ...
                    imagen=imagen+"<input type=\"radio\" name=\"2\" value=\"Portatil 15&#34; + Videoproyector Láser\" id=\"Portatilvideoproyector\" style=\"width: 20px;\" onclick=\"seleccionarFoto(this.value,this.id);\">SELECCIONAR<br />";
                    imagen=imagen+"</div><hr />";
                    document.getElementById('fotosp2').innerHTML = imagen; //OK
                    //imagen 3
                    ...
                    imagen=imagen+"<input type=\"radio\" name=\"2\" value=\"VIAJE SAN ANDRÉS 4 ADULTOS  3 NOCHES 4 DÍAS\" id=\"Sanandres\" style=\"width: 20px;\" onclick=\"seleccionarFoto(this.value,this.id);\">SELECCIONAR<br />";
                    imagen=imagen+"</div><hr />";
                    document.getElementById('fotosp3').innerHTML = imagen; //OK
                    //imagen 4
                    /*imagen="<div class=\"fondopre\"><table style=\"border: 1;width: 98%;\"><tr><td style=\"width: 20%;\">2 TIQUETE AÉREO BOGOTÁ CARTAGENA BOGOTÁ</td>";
                    ...
                    imagen=imagen+"<input type=\"radio\" name=\"2\" value=\"Lavadora-Secadora + Bicicleta montaña.\" id=\"Lavadoravicicleta\" style=\"width: 20px;\" onclick=\"seleccionarFoto(this.value,this.id);\">SELECCIONAR<br />";
                    imagen=imagen+"</div><hr />";
                    document.getElementById('fotosp1').innerHTML = imagen; //OK
                    //imagen2
                    ...
                    imagen=imagen+"<input type=\"radio\" name=\"2\" value=\"VIAJE PUNTA CANA 2 ADULTOS 4 NOCHES 5 DÍAS\" id=\"Puntacana\" style=\"width: 20px;\" onclick=\"seleccionarFoto(this.value,this.id);\">SELECCIONAR<br />";
                    imagen=imagen+"</div><hr />";
                    document.getElementById('fotosp3').innerHTML = imagen; //OK
                    //imagen 4
                    /*imagen="<div class=\"fondopre\"><table style=\"border: 1;width: 98%;\"><tr><td style=\"width: 20%;\">2 TIQUETE AÉREO BOGOTÁ CARTAGENA BOGOTÁ</td>";
            ...
            function guardarDatos(empr) {
                ...
                if (d8.length <= 10) {
                    alert("Digite el correo electrónico");
                    window.scrollTo(10,40);
                ...
                if(empr=='X1'){
                    tipo='P';
                    //var meta2=document.getElementById('T11b').value;
                ...
                peticion_http.onreadystatechange = muestraContenido;
                // Realizar peticion HTTP
                peticion_http.open('POST', 'guardadatpes.php?d1=' + d1 + '&d2=' + d2 + '&d3=' + d3 + '&d4=' + d4 + '&d5=' + d5 + '&d6=' + d6 + '&d6b=' + d6b + '&d7=' + d7 + '&d8=' + d8 + '&d9=' + d9 + '&d10=' + d10 + '&d11=' + d11 + '&d12=' + d12 + '&df=' + df + '&dp=' + dp + '&md=' + md + '&tp=' + tipo + '&pe=' + pe + '&emp=' + empr + '&dp2=' + pe2, true);
                peticion_http.send(null);
    ...
    <body style="background-color: #A7D43D;">
        <?php
       echo "<br /><br /><p><center><STRONG>El Plan año 2020 se encuentra cerrado. Gracias por su visita!. Los esperamos pronto. </STRONG></p></center>";
        ...
        <div class="centrarancho">
            ...
            <form id="formCanvas" name="formCanvas" method="POST" ENCTYPE="multipart/form-data" action="">
                ...
                <tr><td style="width: 10%">&nbsp;</td>
                    ...
                    <li><label class="parrafo">Los premios son &uacute;nicamente los relacionados en el Plan Año 2020.</label></li>  
                    ...
                    <li><label class="parrafo">Se le enviara por correo electr&oacute;nico copia de este acuerdo como soporte del PLAN <br /> AÑO 2020, por favor impr&iacute;mala y cons&eacute;rvela.</label></li>
                    <br />CONDICIONES NOTA CRÉDITO:<br />
                    </ol>
                    <ol>
                    ...
                    <li><label class="parrafo">Para el descuento de la nota del 3% el cliente deber&aacute; tener en cuenta lo siguiente:</label></li> 
                        ...
                        <li><label class="parrafo">Tras recibir la nota cr&eacute;dito, el cliente deber&aacute;  manifestarnos por escrito a qué <br /> facturas se aplicar&aacute;.</label></li>
                        </ol>
                    </ol>
                    <? 
                    ...
                    $ano=strftime('%Y');
                    ?>
                    <center><label class="parrafo" style="text-align: center;">Se expide en BOGOTA D.C a los <? echo $dia; ?> d&iacute;as del mes de <? echo $mes; ?> de <? echo $ano; ?>.</label></center>
                    </p>
                    <?
                    } else if($emp=='X1'){
                    ?>
                    ...
                    <p style="width: 90%;">
                    <label style="font-size: 14pt" class="etiqueta1">Descripci&oacute;n de premios adicionales</label>
                    <div id="descripremios2">
                    
                    </div>
                    <br />CONOCIENDO Y ACEPTANDO LAS SIGUIENTES CONDICIONES:<br />
                    <ol>
                    <li><label class="parrafo">El premio que se genere tomar&aacute; como base para su liquidaci&oacute;n las compras realizadas de enero 21 de 2020 hasta el 20 de enero de 2021.</label></li> 
                    <li><label class="parrafo">V&aacute;lido &uacute;nicamente por compras de medicamentos de Pestar.</label></li> 
                    <li><label class="parrafo">La fecha l&iacute;mite para la entrega de premios ser&aacute; marzo de 2021.</label></li>
                    <li><label class="parrafo">Para la entrega del premio, el cliente debe tener un adecuado manejo del cr&eacute;dito y estar al d&iacute;a en cartera a enero de 2021.</label></li>
                    <li><label class="parrafo">Las facturas emitidas en el periodo antes mencionado deben estar plenamente canceladas.</label></li>
                    <li><label class="parrafo">Una vez verificada la informaci&oacute;n de los puntos 1,2, 3, y 4 se emitir&aacute; al cliente la nota correspondiente y se remitir&aacute; vía correo electr&oacute;nico.</label></li>
                ...
                <tr>
                   <td style="width: 5%">&nbsp;</td>
                   <td colspan="2" style="text-align: justify;">                   
                   &nbsp;&nbsp;&nbsp;&nbsp;<div id="autorizacion" style="width: 88%; color: gray;">
                ...
                <tr>
                   ...
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   <br /><input type="checkbox" ID="datosper" id="datosper" onclick="manejoDatospersonales(this.checked);" style="text-align: center; width: 30px; height:30px; visibility: hidden;" /><label style="visibility: hidden;" id="dper">Acepto el acuerdo anterior.</label>
                   </td>
                </tr>
                <tr><td colspan="3">&nbsp;</td></tr>
               <tr>
                ...
                <tr>
                   ...
                   <input type="text" id="premioelegido2" name="premioelegido2" class="texto1" value="0" autocomplete="off" style="text-align: center; width: 50px; visibility: hidden;" readonly="true" />
