...
<head>
    ...
    <script language="JavaScript">
        ...
        function MinAgricultura(){
            ...
            texto='';
            texto=texto + '<div class="flow-text blue lighten-3" style="font-size:1.5vw;text-align:center;">INF MINAGRICULTURA</div>';
            ...
            texto=texto + '<br /><center><a class="waves-efect waves-light btn" onclick="buscarDatosMA();">Generar Informe</a><center>';
             ...
             <div class="col s7 m12 l12 xl12 blue lighten-2">
                <div class="row blue lighten-2 left">
                        ...
                        <div class="col s6 m4 l10 xl8 blue lighten-2 ">
                            <br /><div class="flow-text" style="font-size:3vw;text-align:right;">REPORTE MINAGRICULTURA</div>
                        </div>
                </div>
                <div class="row blue lighten-2">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <nav>
                    ...
                    <div class="nav-wrapper red lighten-2 white-text bordes">
                        ...
                        <ul id="nav-mobile" class="right">
                            <!--<li><a href="javascript:MinAgricultura()">Informe MinAgricultura</a></li>-->
                ...
                <div class="row">
                    ...
                    <div class="row white center">
                        ...
                        <div class="row center blue lighten-3">
                          ...
                          <!--inicio-->
                          <!--SUBIDA DE ITEMS MINAGRICULTURA AGROCAMPO-->
                                
                                <div style="width: 98%; background-color: #CDCDCD;">
                          <br /><label class="black-text"><b>SUBIR ARCHIVO ITEMS MINAGRICULTURA AG</b></label>
                          <br /><label class="black-text"><b>EXCEL Cols: (ITEM, MANEJADOR)</b></label>
                          <br /><br />
                                  <form enctype="multipart/form-data" action="index.php" method="POST">
                                    ...
                                    <input type="submit" class="waves-efect waves-light btn" name="EnviarItem" value="Enviar fichero" /><br /><br />
                                </form>
                          </div><br />
                                <?php
                                // En versiones de PHP anteriores a la 4.1.0, deber�a utilizarse $HTTP_POST_FILES en lugar
                                // de $_FILES.
                                if (isset($_POST['EnviarItem'])){
                                    $dir_subida = '/var/www/html/modulo_plan/infminagricultura/';
                                    ...
                                    //$mipath="Bloque1.xlsx";//$archis;
                                    if(file_exists($mipath)) {
                                        include('conectarbase.php');
                                        //borra la tabla 
                                        $queryBorra = mssql_query("DELETE FROM [InformesCompVentas].[dbo].[InfItemsMinAgricultura]");
                                        ...
                                        for ($row = 2; $row <= $highestRow; $row++){ 
                                            $grp=trim($sheet->getCell("B".$row)->getValue());
                                            $man=trim($sheet->getCell("C".$row)->getValue());
                                            $grp="Q".$grp;
                                            $dato2='';
                                            $query = mssql_query("SELECT * FROM [InformesCompVentas].[dbo].[InfItemsMinAgricultura] WHERE Item='".$grp."' AND Manejador='".$man."'");
                                            if (!mssql_num_rows($query)) {
                                                $sqlv = "INSERT INTO [InformesCompVentas].[dbo].[InfItemsMinAgricultura](Item,Manejador)VALUES('$grp','$man')"; 
                                                mssql_query($sqlv,$cLink);
                                            }
                                        }
                                        echo "  Datos de items inventario fueron actualizados correctamente. ";
                                        unset($objPHPExcel);
                                        unset($objReader);
                          ...
                          <div style="width: 98%; background-color: #CDCDCD;">
                          <br /><label class="black-text"><b>SUBIR ARCHIVO BASE ITEMS INVENTARIO de JAVIER</b></label>
                          <br /><label class="black-text"><b>EXCEL Cols: (ITEM, BODEGA, EXIST, MANEJ)</b></label>
                          <br /><label class="black-text"><b>Filtrar por: (RODRIGUEZF, PINILLOSM, Bod (005,008)</b></label>
                          <br /><br />
                                  <form enctype="multipart/form-data" action="index.php" method="POST">
                                    <!-- MAX_FILE_SIZE debe preceder al campo de entrada del fichero -->
                                    <input type="hidden" name="MAX_FILE_SIZE" value="30000" />
                                    <!-- El nombre del elemento de entrada determina el nombre en el array $_FILES -->
                                    <input name="fichero_usuario" type="file" class="waves-efect waves-light btn"  /><br /><br />
                                    <input type="submit" class="waves-efect waves-light btn" name="EnviarInv" value="Enviar fichero" /><br /><br />
                                </form>
                          </div><br />
                                <?php
                                // En versiones de PHP anteriores a la 4.1.0, deber�a utilizarse $HTTP_POST_FILES en lugar
                                // de $_FILES.
                                if (isset($_POST['EnviarInv'])){
                                    $dir_subida = '/var/www/html/modulo_plan/infminagricultura/Meses/';
                                    $fichero_subido = $dir_subida . basename($_FILES['fichero_usuario']['name']);
                                    if (move_uploaded_file($_FILES['fichero_usuario']['tmp_name'], $fichero_subido)) {
                                        echo "El archivo se subio bien.\n";
                                    } else {
                                    ...
                                    if(file_exists($mipath)) {
                                        include('conectarbase.php');
                                        //borra la tabla 
                                        $queryBorra = mssql_query("DELETE FROM [InformesCompVentas].[dbo].[InfMinAgricultura]");
                                        if (mssql_num_rows($queryBorra)) {
                                             echo "Tabla limpiada ";   
                                        }
                                        //lee excel
                                        ...
                                        for ($row = 2; $row <= $highestRow; $row++){ 
                                            ...
                                            $bod=trim($sheet->getCell("B".$row)->getValue());
                                            $exi=trim($sheet->getCell("C".$row)->getValue());
                                            $mnj=trim($sheet->getCell("D".$row)->getValue());
                                            $dato2='';
                                            $grp="Q".$grp;
                                            $query = mssql_query("SELECT * FROM [InformesCompVentas].[dbo].[InfMinAgricultura] WHERE Item='".$grp."' AND Bodega='".$bod."' AND Manejador='".$mnj."'");
                                            if (!mssql_num_rows($query)) {
                                                $sqlv = "INSERT INTO [InformesCompVentas].[dbo].[InfMinAgricultura](Item,Descripcion,Bodega,Existen,Manejador)VALUES('$grp','','$bod','$exi','$mnj')"; 
                                                mssql_query($sqlv,$cLink);
                                            }
                                        }
                                        echo "  Datos de items inventario fueron actualizados correctamente. ";
                                        ...
                                        echo "Archivo no encontrado en el servidor1. datos no fueron actualizados.";
                                    }
                                }
                                ?>
                             ...
                             <table style="width: 98%; background-color: #CDCDCD;">
                            <tr><td colspan="4" style="text-align: center;"><label class="black-text"><b>CONSULTAR DATOS VENTAS DE IBS</b></label>
                            <br /><label class="black-text"><b>VISTA VISINFMINAGR (Trae Mes Anterior)</b></label>
                            </td></tr>
                            <tr>
                            <td style="width: 30%;"> 
                          ...
                          <td>
                            <a class="waves-efect waves-light btn" onclick="buscarDatosMAInv();">1.SAVE_Inv</a>
                          </td>
                          <td>
                            <a class="waves-efect waves-light btn" onclick="buscarDatosMA();">2.SAVE_Ven</a>
                          </td>
                          <td>
                            <a class="waves-efect waves-light btn" onclick="GenerarReporteXLS();">3.DescargarInf</a>
                          </td>
                          </tr>
                          </table>   
                          <hr />
