...
<html lang="en">
    <head>
    <script> setTimeout(«window.location.replace('http://sia.pestar.com.co/modulo_plan/indexp.php?emp=X1')»,1000) </script>
        <style type="text/css">
        .centrador{
        ...
        <script language="JavaScript">
            ...
            function seleccionarFoto(premio,premioelegido,tpp,nombreFoto){
                    ...
                    if (peticion_http.readyState == 4) {
                        if (peticion_http.status == 200) {
                            ...
                            while(f<c-1){
                                ...
                                imagen=imagen+"<td style=\"width: 50%;background-color: #FFFFFF; text-align: center;\"><BR /><img src=\""+ruta+"\" alt=\"premio\" style=\"width: 98%;\" /><BR /></td><td style=\"padding: 5px;\"><label class=\"parrafo\">"+texto2+"</label> </td></tr></table>";
                                imagen=imagen+"<input type=\"radio\" name=\"2\" value=\""+nombrefoto+"\" id=\""+nombrefoto+"\" style=\"width: 20px;\" onclick=\"seleccionarFoto(this.value,this.id,'"+texto3+"','"+texto1+"');\">SELECCIONAR<br />";
            ...
            function guardarDatos(empr) {
                ...
                peticion_http.open('POST', 'guardadat.php?d1=' + d1 + '&d2=' + d2 + '&d3=' + d3 + '&d4=' + d4 + '&d5=' + d5 + '&d6=' + d6 + '&d6b=' + d6b + '&d7=' + d7 + '&d8=' + d8 + '&d9=' + d9 + '&d10=' + d10 + '&d11=' + d11 + '&d12=' + d12 + '&df=' + df + '&dp=' + dp + '&md=' + md + '&tp=' + tpp + '&pe=' + pe + '&emp=' + empr + '&txtImg=' + txtImg, true);
                peticion_http.send(null);
       ...
       <div class="centrarancho">
            ...
            <form id="formCanvas" name="formCanvas" method="POST" ENCTYPE="multipart/form-data" action="">
                ...
                <tr><td style="width: 10%">&nbsp;</td>
                    ...
                    <ol>
                    <li><label class="parrafo">Concurso valido por compras antes de IVA desde enero 1 hasta el 24 de diciembre 2021.</label></li> 
                    ...
                    <li><label class="parrafo">Los premios son &uacute;nicamente los relacionados en el Plan Año 2021.</label></li>  
                    <li><label class="parrafo">Plazo m&aacute;ximo para la firma del negocio es abril 15 de 2021.</label></li> 
                    ...
                    <li><label class="parrafo">Se le enviara por correo electr&oacute;nico copia de este acuerdo como soporte del PLAN AÑO 2021, por favor impr&iacute;mala y cons&eacute;rvela.</label></li>
                    <br />CONDICIONES NOTA CR&Eacute;DITO:<br />
                    </ol>
                    <ol>
                    <li><label class="parrafo">El premio que se genera a trav&eacute;s de la nota cr&eacute;dito tomar&aacute; como base para su liquidaci&oacute;n las compras realizadas del del 1 de enero al 24 de diciembre de 2021 antes de IVA. (V&aacute;lido &uacute;nicamente<br /> por compras de medicamentos y productos importados directamente por Agrocampo.)</label></li> 
                    <li><label class="parrafo">Para el descuento de la nota del 3% el cliente deber&aacute; tener en cuenta lo siguiente:</label></li> 
                        <ol type="a">
                        <li><label class="parrafo">Las compras deben ser de enero 1 hasta el 24 de diciembre 2021.</label></li>
                    ...
                    <br />CONOCIENDO Y ACEPTANDO LAS SIGUIENTES CONDICIONES:<br />
                    <ol>
                    <li><label class="parrafo">Concurso valido desde enero 1 de 2021 hasta el 21 de diciembre de 2021.</label></li> 
