            ...
            class PDF extends FPDF
            {
                function Header(){
                    ...
                    //cabecera de la tabla
                        ...
                        $this->SetXY(105, 20);
                        $this->Cell(10,7, 'INFORME DE VENTAS AÑO ANTERIOR vs ACTUAL ODOO', 0, 'C', 'C','0','');
                        //$this->SetXY(95, 30);
    ...
    while($cm < $tm){
            ...
            while($resultadocat = mssql_fetch_array($resultSQLCat)){
                    ...
                    while($resultadoTot = mssql_fetch_array($resultSQLTot)){
                        ...
                        $resultSQLA = mssql_query("SELECT SUM(VLR_EXC_IVA) AS T1 FROM infVentasIbsOdoo WHERE PERIODO='$periodoant' AND IDPGRP='$d1'");
                        ...
                        $resultSQLB = mssql_query("SELECT SUM(VLR_EXC_IVA) AS T2 FROM [InformesCompVentas].[dbo].[infVentasIbsOdoo] WHERE PERIODO='$periodo' AND IDPGRP='$d1'");
    ...
    while($cm < $tm){
            ...
            while($resultadocat = mssql_fetch_array($resultSQLCat)){
                ...
                while($resultadoTot = mssql_fetch_array($resultSQLTot)){
                    ...
                    //CRECIMIENTO
                    //SUBTOTAL CRECIMIENTO POR CATEGORIAS
            ...
            $cod=time()+1;
            $nombrearc="pdf/INFORME_VENTAS_MES_ANIOACT_VS_ANIOANT_ODOO.pdf";
