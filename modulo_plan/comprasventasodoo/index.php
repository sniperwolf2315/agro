...
<head>
    ...
    <script language="JavaScript">
        ...
        function buscarDatos1() {
                ...
                //usinf
                var man=document.getElementById('usinf').value;
                var periodo=ano + mes;
                if(mes.length<2){
                ...
                if (periodo != "") {
                    ...
                    peticion_http.open('POST', 'buscardatos1.php?periodo=' + periodo + '&man=' + man, true);
                    ...
                    function muestraContenido() {
                        ...
                        if (peticion_http.readyState == 4) {
                            if (peticion_http.status == 200) {
                                ...
                                verLink('INFORME_COMPRAS_VENTAS_MES_ODOO.pdf');
        ...
        function buscarDatos2() {
                ...
                if (periodo != "") {
                    ...
                    peticion_http.onreadystatechange = muestraContenido;
                    // Realizar peticion HTTP
                    peticion_http.open('POST', 'buscardatos2.php?periodo=' + periodo + '&man=' + man, true);
                    peticion_http.send(null);
                    ...
                    function muestraContenido() {
                        ...
                        if (peticion_http.readyState == 4) {
                            if (peticion_http.status == 200) {
                                ...
                                //INFORME_COMPRAS_VENTAS_MES.pdf
                                document.getElementById('estado').innerHTML='';
                                verLink('INFORME_COMPRAS_VENTAS_MES_ACUMULADO_ODOO.pdf');
                                //document.getElementById('estado').innerHTML='LISTO';
                                document.body.style.cursor = 'auto';
                                //document.getElementById('refer').value = dato;
                            }
        ...
        function buscarDatos3() {
                ...
                if (periodo != "") {
                    ...
                    peticion_http.onreadystatechange = muestraContenido;
                    // Realizar peticion HTTP
                    peticion_http.open('POST', 'buscardatos3.php?periodo=' + periodo + '&man=' + man, true);
                    peticion_http.send(null);
                    ...
                    function muestraContenido() {
                        ...
                        if (peticion_http.readyState == 4) {
                            if (peticion_http.status == 200) {
                                ...
                                //INFORME_COMPRAS_VENTAS_MES.pdf
                                document.getElementById('estado').innerHTML='';
                                verLink('INFORME_VENTAS_MES_ANIOACT_VS_ANIOANT_ODOO.pdf');
                                //document.getElementById('estado').innerHTML='LISTO';
                                document.body.style.cursor = 'auto';
                                //document.getElementById('refer').value = dato;
                            }
        ...
        function buscarDatos4() {
                ...
                if (periodo != "") {
                    ...
                    peticion_http.onreadystatechange = muestraContenido;
                    // Realizar peticion HTTP
                    peticion_http.open('POST', 'buscardatos4.php?periodo=' + periodo + '&man=' + man, true);
                    peticion_http.send(null);
                    ...
                    function muestraContenido() {
                        ...
                        if (peticion_http.readyState == 4) {
                            if (peticion_http.status == 200) {
                                ...
                                //INFORME_COMPRAS_VENTAS_MES.pdf
                                document.getElementById('estado').innerHTML='';
                                verLink('INFORME_VENTAS_MES_ANIOACT_VS_ANIOANT_ACUMULADO_ODOO.pdf');
                                //document.getElementById('estado').innerHTML='LISTO';
                                document.body.style.cursor = 'auto';
                                //document.getElementById('refer').value = dato;
                            }
        ...
        function Guardar_Vista() {
                ...
                if (periodo != "") {
                    ...
                    peticion_http.open('POST', 'algo.php?p=' + periodo + '&v=' + vista, true);
                    peticion_http.send(null);
                    ...
                    function muestraContenido() {
                        if (peticion_http.readyState == 4) {
                            if (peticion_http.status == 200) {
                                var dato = peticion_http.responseText;
                                //alert(dato);
                                document.getElementById('formu').innerHTML=dato;
                                document.body.style.cursor = 'auto';
                            }
                        }
                    }
                }else{
                    alert('Seleccione mes, año y accion a realizar');
                }      
            }
            ...
            function Guardar_Grupo() {
                ...
                var descripnew=document.getElementById('Descripnew').value;
                if(grupo==""){
                ...
                if(descripnew==""){
                    ...
                    // Realizar peticion HTTP
                    //peticion_http.open('POST', 'guardarvista.php?periodo=' + periodo + '&vista=' & vista, true);
                    peticion_http.open('POST', 'grupos.php?g=' + grupo + '&m=' + manejador + '&c=' + categoria + '&d=' + descripnew, true);
                    peticion_http.send(null);
        ...
        function Comp_Vent_Mes(){
            ...
            texto=texto + '<select id="usinf" class="browser-default light-blue-text" style="width: 200hw;">';
            texto=texto + '<option value="TODOS">TODOS</option>';
            texto=texto + '<option value="MARTHA PINILLOS">MARTHA PINILLOS</option>';
            texto=texto + '<option value="FELIPE BARON">FELIPE BARON</option>';
            texto=texto + '<option value="FANNY RODRIGUEZ">FANNY RODRIGUEZ</option>';
            texto=texto + '<option value="MARCELA SUAREZ">MARCELA SUAREZ</option>';
            texto=texto + '</select>';
                        
            texto=texto + '<div class="flow-text blue lighten-3" style="font-size:1.5vw;text-align:center;">COMPRAS-VENTAS MES</div>';
            
            texto=texto + '<div class="input-field col s4">';
            ...
            <!--menu izq-->
             ...
             <div class="col s7 m12 l12 xl12 blue lighten-2">
                <div class="row blue lighten-2 left">
                        ...
                        <div class="col s6 m6 l10 xl8 blue lighten-2 ">
                            <br /><div class="flow-text" style="font-size:2vw;text-align:right;">REPORTE COMPRAS Y VENTAS ODOO</div>
                        </div>
                </div>
                <div class="row blue lighten-2">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div class="row">
                    ...
                    <div class="row white center">
                        ...
                        <div class="row center blue lighten-3">
                            ...
                            <tr><td colspan="4" style="text-align: center;"><label class="black-text"><b>SUBIR DATOS VENTAS o COMPRAS DE ODOO</b></label></td></tr>
                            <tr>
                            <td style="width: 30%;"> 
                          ...
                          <td style="width: 30%;">
                            <select id="v" class="browser-default light-blue-text" style="width: 200hw;">
                          ...
                          <td>
                            <a class="waves-efect waves-light btn" onclick="Guardar_Vista();">GuardarVC</a>
                          ...
                          <table style="width: 98%; background-color: #CDCDCD;">
                            ...
                            <tr>
                               <td style="width: 40%;">
                                ...
                                <select id="maneja" class="browser-default light-blue-text" style="width: 200hw;">
                                    ...
                                    $resultSQLG = mssql_query("SELECT DISTINCT(RESPONSABLE) FROM [InformesCompVentas].[dbo].[infPeriodosAcumuladosOdoo] GROUP BY RESPONSABLE");
                            ...
                            <tr>
                            <td colspan="2">
                                <label class="black-text"><b>DESCRIPCION - RAZON SOCIAL:</b></label> 
                                <input type="text" onkeyup="javascript:this.value=this.value.toUpperCase();" class="black-text" id="Descripnew" maxlength="200" /><br />
                            </td>                            
                            </tr>
                          ...
                          <br /><label class="black-text"><b>SUBIR ARCHIVO DE INVENTARIO MES (Auditoria)</b></label>
                          <br /><label class="black-text"><b>EXCEL: GRUPO - suma(COSTOTOTAL) - PERIODO(202011)</b></label>
                          <br /><br />
                                  <form enctype="multipart/form-data" action="index.php" method="POST">
                                ...
                                if (isset($_POST['Enviar'])){
                                    ...
                                    if(file_exists($mipath)) {
                                        ...
                                        //limpia tabla
                                        $sqlb = "DELETE FROM [InformesCompVentas].[dbo].[infConsolidadoInvSigOdoo] WHERE PERIODO='$per'";
                                        ...
                                        for ($row = 2; $row <= $highestRow; $row++){ 
                                            ...
                                            $dato2='';
                                            $query = mssql_query("SELECT * FROM [InformesCompVentas].[dbo].[infConsolidadoInvSigOdoo] WHERE GRUPO='".$grp."' AND PERIODO='".$per."'");
                                            if (!mssql_num_rows($query)) {
                                                $sqlv = "INSERT INTO [InformesCompVentas].[dbo].[infConsolidadoInvSigOdoo](GRUPO,COSTO_TOTAL,PERIODO) VALUES('$grp','$vrl','$per')"; 
