        ...
        <script language="JavaScript">
            ...
            function consultarPremios(){
                ...
                if(d1=='1' && parar=='0'){
                    ...
                    imagen=imagen+"<td style=\"width: 50%;background-color: #FFFFFF; text-align: center;\"><BR /><img src=\"FOTOSPLAN/6/Motobombamotosierra.png\" alt=\"premio\" /><BR /></td><td style=\"padding: 5px;\"><label class=\"parrafo\">Motobomba:descarga: 3 x 3, Autocebante aluminio gasolina 5.5 hp , presión máxima: 30 metros, caudal máximo: 1000 litros/min. Motosierra: Cilindrada: 87 ??³, Potencia: 4.5 kW, Longitud de espada recomendada mín-máx : 70 cm, Peso sin equipo de corte: 7.6 kg, Bomba de aceite regulable, Cárter de Magnesio, mango ergonómico.</label></td></tr></table>";
