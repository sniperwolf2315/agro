    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function consultarDatos(empresa) {
                ...
                peticion_http.open('POST', 'buscarplan.php?emp=' + empresa + '&d1=' + d1, true);
            ...
            function guardarDatos() {
                ...
                peticion_http.onreadystatechange = muestraContenido;
                // Realizar peticion HTTP
                peticion_http.open('POST', 'guardadat.php?d1=' + d1 + '&d2=' + d2 + '&d3=' + d3 + '&d4=' + d4 + '&d5=' + d5 + '&d6=' + d6 + '&d6b=' + d6b + '&d7=' + d7 + '&d8=' + d8 + '&d9=' + d9 + '&d10=' + d10 + '&d11=' + d11 + '&d12=' + d12 + '&df=' + df + '&dp=' + dp + '&md=' + md + '&tp=' + tipo + '&pe=' + pe, true);
                peticion_http.send(null);
        ...
        <div class="centrarancho">
            ...
            <tr><td colspan="3">&nbsp;</td></tr>
               ...
               <tr>
                ...
                <tr>
                   <td>&nbsp;</td>
                   <td><label style="font-size: 14pt" class="etiqueta1">OBJETIVO DE COMPRAS 2020</label></td>
                ...
                <tr>
                   ...
                   <textarea id="Premio" name="Premio" rows="2" placeholder="campo obligatorio" class="texto2" readonly="true"></textarea>
                   </td>
                </tr>
                <tr><td colspan="3">&nbsp;</td></tr>
                <tr>
            ...
            <form id="formCanvas" name="formCanvas" method="POST" ENCTYPE="multipart/form-data" action="">
                ...
                <tr><td style="width: 10%">&nbsp;</td>
                    ...
                    $mes=strftime('%B');
                    ?>
                    <center><label class="parrafo" style="text-align: center;">Se expide en BOGOTA D.C a los <? echo $dia; ?> d&iacute;as del mes de <? echo $mes; ?> de 2020.</label></center>
                    </p>
                    <?
                    } else if($emp=='X1'){
                    ?>
                    <p style="width: 90%;">
                    <ol>
                    <li><label class="parrafo">Premio a&ntilde;o para la empresa en mercanc&iacute;a al final del a&ntilde;o comercial del <? echo $P1; ?>% del total de las compras despu&eacute;s de descuentos.</label></li> 
                    <li><label class="parrafo">Premio a&ntilde;o para la empresa en Nota Cr&eacute;dito al final de a&ntilde;o comercial del <? echo $P2; ?>% del total de las compras despu&eacute;s de descuentos.</label></li> 
                    <li><label class="parrafo">Incentivos vendedores: Bonos o mercanc&iacute;a <? echo $P3; ?>% sobre las compras despu&eacute;s de descuentos, que se liquidar&aacute;n semestralmente y proporcional al cumplimiento del negocio a&ntilde;o para que se entregue a los vendedores de mostrador y externos por cumplimiento de ventas, para esto se debe entregar relaci&oacute;n firmada con valor por vendedor que recibi&oacute; el incentivo.<br /> Esta nota podr&aacute; ser cambiada por bonos Sodexo Pass, previa autorizaci&oacute;n del representante legal.</label></li>
                    <br />CONOCIENDO Y ACEPTANDO LAS SIGUIENTES CONDICIONES:<br />
                    </ol>
                    <ol>
                    <li><label class="parrafo">Concurso valido desde enero 1 de 2020 hasta el 21 de diciembre de 2021.</label></li> 
                    ...
                    <li><label class="parrafo">Ex&iacute;jale a su asesor comercial copia del plan a&ntilde;o firmado, este documento ser&aacute; solicitado en el momento de la entrega del premio.</label></li>
                    </ol>
                    <? 
                    setlocale(LC_ALL, 'spanish');
                    //strftime('%d de %B del %Y'); 
