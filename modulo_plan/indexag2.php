    ...
    <head>
        ...
        <script language="JavaScript">
                    ...
                    if (peticion_http.readyState == 4) {
                        if (peticion_http.status == 200) {
                            ...
                            while(f<c-1){
                                ...
                                imagen=imagen+"<td style=\"width: 50%;background-color: #FFFFFF; text-align: center;\"><BR /><img src=\""+ruta+"\" alt=\"premio\" style=\"width: 98%;\" /><BR /></td><td style=\"padding: 5px;\"><label class=\"parrafo\">"+texto2+"</label><input type=\"text\" id='condiciones"+f+"' value='"+texto2+"'> </td></tr></table>";
            ...
            function guardarDatos(empr) {
                ...
                peticion_http.open('POST', 'guardadat2.php?d1=' + d1 + '&d2=' + d2 + '&d3=' + d3 + '&d4=' + d4 + '&d5=' + d5 + '&d6=' + d6 + '&d6b=' + d6b + '&d7=' + d7 + '&d8=' + d8 + '&d9=' + d9 + '&d10=' + d10 + '&d11=' + d11 + '&d12=' + d12 + '&df=' + df + '&dp=' + dp + '&md=' + md + '&tp=' + tpp + '&pe=' + pe + '&emp=' + empr + '&txtImg=' + txtImg + '&cond=' + cond, true);
                peticion_http.send(null);
            ...
            <form id="formCanvas" name="formCanvas" method="POST" ENCTYPE="multipart/form-data" action="">
               ...
               <tr>
                ...
                <tr>
                   ...
                   <input type="text" value="" id="condicion" style="width: 100px; visibility: visible;" />
