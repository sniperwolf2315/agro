...
require('fpdf/fpdf.php');
            ...
            class PDF extends FPDF
            {
                function Header(){
                    ...
                    //cabecera de la tabla
                        ...
                        $this->Cell(10,7, 'INFORME DE VENTAS AÑO ANTERIOR vs ACTUAL ACUMULADO', 0, 'C', 'C', '');
    ...
    while($cm < $tm){
            ...
            while($resultadocat = mssql_fetch_array($resultSQLCat)){
                    ...
                    while($resultadoTot = mssql_fetch_array($resultSQLTot)){
                        ...
                        $resultSQLA = mssql_query("SELECT SUM(VLR_EXC_IVA) AS T1 FROM infVentasIbs WHERE PERIODO BETWEEN '$periodoiant' AND '$periodoant' AND IDPGRP='$d1'");
                        ...
                        $resultSQLB = mssql_query("SELECT SUM(VLR_EXC_IVA) AS T2 FROM [InformesCompVentas].[dbo].[infVentasIbs] WHERE PERIODO BETWEEN '$periodoi' AND '$periodo' AND IDPGRP='$d1'");
    ...
    while($cm < $tm){
            ...
            $cod=time()+1;
            $nombrearc="pdf/INFORME_VENTAS_MES_ANIOACT_VS_ANIOANT_ACUMULADO.pdf";
