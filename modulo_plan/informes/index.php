                ...
                <div class="row">
                    ...
                    <div class="row white center">
                        ...
                        <div class="row center blue lighten-3">
                            ...
                            <th>
                                <!-- <td>
                                    <form method="POST" action="cargar_excel_1.php" enctype="multipart/form-data">
                                        <div>
                                            <div class="mb-6" style="font-size:18px; ">
                                                <label for="formFileLg" class="form-label">Cargar Archivo xlsx</label><br>
                                ...
                                <td>
                                    <a href="cargar_excel_1.php" target="_blank"  > 
                                        <img src="img/transferencia.png" width="20" height="20" >    
                                        Cargar_Excel
                                     </a>
                                </td>
                            </th>
                            ...
                            <table style="width: 98%; background-color: #CDCDCD;">
                            <tr><td colspan="4" style="text-align: center;"><label class="black-text"><b>SUBIR DATOS VENTAS o COMPRAS DE IBS</b></label></td></tr>
                            <tr>
                            <td style="width: 30%;"> 
                          ...
                          <br /><label class="black-text"><b>SUBIR ARCHIVO DE INVENTARIO MES</b></label>
