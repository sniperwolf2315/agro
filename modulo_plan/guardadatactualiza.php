<?php
            ...
            $urlcliente='http://sia.agrocampo.vip/modulo_plan/FIRMAVENDEDOR/1.png';
            $firma=$d1.'.png';
            //premios
            if(empty($_GET['dp'])){
                $dp='Ninguno';
            ...
            if($emp=='AG'){
                $result = mssql_query("SELECT * FROM zAgroPremios2021 WHERE Cedula='$d1' and Estado='1'");
            }else if($emp=='X1'){
                $result = mssql_query("SELECT * FROM zAgroPremiosPestar2021 WHERE Cedula='$d1' and Estado='1'");
            }
            ...
            if($resultado){
                ...
                $fechareg=$resultado["Fecha"];  //$dia.'/'.$mes.'/2021';
                ...
                //if($largo<5){
                    if($dp!='Ninguno'){
                        if($emp=='AG'){
                            ...
                            $consulta2=$consulta2." VALUES('$nom','$m2018','$c2018','$avance','$montoc','$firma','$fechareg','$nomest','$d1','$d8','$dpto','$ciud','$d4','$d5','$d6b','$d7','2','$cate','$dp','$urlcliente','$codv','$tipo','$md','$emp','$pelegido2','$url','$condc')";
                            $resultado1=mssql_query($consulta2);
                            //actualiza
                            //$consulta3= "UPDATE zAgroPremios2021 SET Nombre='$nom' WHERE Cedula='$d1' and Estado='1' and Id='$Id'";
                            //$resultado2=mssql_query($consulta3);
                        }else if($emp=='X1'){
                            //$consulta3= "UPDATE zAgroPremiosPestar2021 SET Nombre='$nom' WHERE Cedula='$d1' and Estado='1' and Id='$Id'";
                            //$resultado2=mssql_query($consulta3);
                    ...
                    //$resultado=$mysqli->query($consulta);
                        if($resultado1){
                            echo("Datos fueron actualizados, se volvera a generar el PDF.");
                        }else{
