            ...
            function consultarDatos(empresa) {
                ...
                function muestraContenido() {
                    if (peticion_http.readyState == 4) {
                        //alert("Usted ya entro en el plan año 2022.");
                        if (peticion_http.status == 200) {
                            ...
                            if (dato.length <= 23) {
                                ...
                                if(datos[12].length > 3){
                                    alert("Usted ya registro el plan año 2022.");
                                    setTimeout("location.reload(true);", 200);
                                    return false;
                                }else{
                                    //document.getElementById('nplan').innerHTML = 'REGISTRO PLAN A&Ntilde;O 2022 #:' + datos[10];
        ...
        <div class="centrarancho">
            ...
            <form id="formCanvas" name="formCanvas" method="POST" ENCTYPE="multipart/form-data" action="">
                ...
                <tr><td style="width: 10%">&nbsp;</td>
                    ...
                    <p style="width: 90%;">
                    <ol>
                    <li><label class="parrafo">Concurso valido por compras desde enero 1 hasta el 21 de diciembre 2021.</label></li> 
                    ...
                    <li><label class="parrafo">La entrega del premio se har&aacute; m&aacute;ximo el 30 de abril de 2022.</label></li>  
                    ...
                    <li><label class="parrafo">Los viajes son redimibles &uacute;nicamente en temporada baja y durante el 2022. No incluye <br /> puentes ni festivos. La fecha debe ser acordada con m&iacute;nimo 3 meses de anticipaci&oacute;n,<br /> la cual no debe ser cambiada debido a los altos costos que implica.</label></li>
                    <li><label class="parrafo">Se le enviara por correo electr&oacute;nico copia de este acuerdo como soporte del PLAN <br /> AÑO 2022, por favor impr&iacute;mala y cons&eacute;rvela.</label></li>
