<?php
    ...
    //desactivar plan año
// echo "<br /><br /><p><center><STRONG>El Plan año 2023 se encuentra cerrado, Gracias por su visita! los esperamos su visita en <a href='https://www.agrocampo.com.co/'>Agrocampo - Todo en veterinaria</a></STRONG></p></center>";
        ...
        <script language="JavaScript">
            ...
            function manejoDatospersonales(estado){
                ...
                var texto='<div class="descricondiciones"><br />';
                    ...
                    texto=texto + 'responsabilidad de PESTAR S.A.S, para que sean tratados con la finalidad de realizar gestión ';
                    ...
                    texto=texto + ' infracción sobre mis datos, mediante un escrito dirigido a PESTAR S.A.S., a la dirección de correo electrónico protección.';
            ...
            function consultarDatos(empresa) {
                ...
                function muestraContenido() {
                    if (peticion_http.readyState == 4) {
                        //alert("Usted ya entro en el plan año 2023.");
                        if (peticion_http.status == 200) {
                            ...
                            if (dato.length <= 23) {
                                ...
                                if(datos[12].length > 3){
                                    alert("Usted ya registro el plan año 2023.");
                                    setTimeout("location.reload(true);", 200);
                                    return false;
                                }else{
                                    //document.getElementById('nplan').innerHTML = 'REGISTRO PLAN A&Ntilde;O 2023 #:' + datos[10];
            ...
            function consultarPorcentajes(p1,p2,p3){
                ...
                var x3=-1;
                 //if(d1=='1' && parar=='0'){
                    ...
                    if(x1!=-1){
                    //if(p1!='0%'){
                        imagen1="<div class=\"fondopre\"><table style=\"border: 0;width: 98%;\"><tr><td style=\"width: 50%;\">Premio a&ntilde;o para la empresa en mercancía al final del año comercial del "+p1p+"% del total de las compras después de descuentos.</td>";
                        ...
                        premio1="Premio año para la empresa en mercancía del " + p1p;
                    }
                    ...
                    //if(p2!='0%'){
                        ...
                        imagen2="<div class=\"fondopre\"><table style=\"border: 1;width: 98%;\"><tr><td style=\"width: 50%;\">Premio a&ntilde;o para la empresa en Nota Cr&eacute;dito al final de año comercial del "+p2p+"% del total de las compras despu&eacute;s de descuentos.</td>";
                        ...
                        //alert(imagen);
                        premio2=premio+"Premio año para la empresa en Nota Crédito del " + p2p;
                    }
                    ...
                    if(x3!=-1){
                        //imagen="<table><tr><td>"+mas+"</td></tr></table>";
                        imagen3="<div class=\"fondopre\"><table style=\"border: 1;width: 98%;\"><tr><td style=\"width: 50%;\">Incentivos vendedores: Bonos o mercanc&iacute;a "+p3p+"% sobre las compras después de descuentos.</td>";
                        ...
                        premio3=premio+"Incentivos vendedores: Bonos o mercancía sobre compras del " + p3p;
                    }
                    //document.getElementById('fotosp3').innerHTML = imagen3;
        ...
        <div class="centrarancho">
            ...
            <tr><td colspan="3">&nbsp;</td></tr>
               ...
               <tr>
                ...
                <tr>
                   ...
                   <td><input type="text" ID="T6" name="T6" maxlength="12" onkeyUp="return ValNumero(this);" class="texto2" autocomplete="off" readonly="false" /></td>
                   <td></td>
               </tr>
                <tr><td colspan="3"></td></tr>
                <tr>
               ...
               <tr>
                ...
                <tr>
                   <td>&nbsp;</td>
                   <td><label style="font-size: 14pt" class="etiqueta1">OBJETIVO DE COMPRAS 2023</label></td>
            ...
            <form id="formCanvas" name="formCanvas" method="POST" ENCTYPE="multipart/form-data" action="">
                ...
                <tr><td style="width: 10%">&nbsp;</td>
                    ...
                    <p style="width: 90%;">
                    <ol>
                    <li><label class="parrafo">Concurso valido por compras desde enero 1 hasta el 23 de diciembre 2023.</label></li> 
                    ...
                    <li><label class="parrafo">Los premios son &uacute;nicamente los relacionados en el Plan Año 2023.</label></li>  
                    <li><label class="parrafo">Plazo m&aacute;ximo para la firma del negocio es abril 15 de 2023.</label></li> 
                    ...
                    <li><label class="parrafo">Los viajes son redimibles &uacute;nicamente en temporada baja y durante el 2023. No incluye <br /> puentes ni festivos. La fecha debe ser acordada con m&iacute;nimo 3 meses de anticipaci&oacute;n,<br /> la cual no debe ser cambiada debido a los altos costos que implica.</label></li>
                    <li><label class="parrafo">Se le enviara por correo electr&oacute;nico copia de este acuerdo como soporte del PLAN <br /> AÑO 2023, por favor impr&iacute;mala y cons&eacute;rvela.</label></li>
                    <br />CONDICIONES NOTA CRÉDITO:<br />
                    </ol>
                    <ol>
                    <li><label class="parrafo">El premio que se genera a trav&eacute;s de la nota cr&eacute;dito tomar&aacute; como base para su liquidaci&oacute;n<br /> las compras realizadas del 1 de enero al 18 de diciembre de 2021. (V&aacute;lido &uacute;nicamente<br /> por compras de medicamentos y producto importados directamente por Agrocampo.)</label></li> 
                    <li><label class="parrafo">Para el descuento de la nota del 3% el cliente deber&aacute; tener en cuenta lo siguiente:</label></li> 
                        <ol type="a">
                        <li><label class="parrafo">Las compras deben ser de enero 1 hasta el 21 de diciembre 2021.</label></li>
                    ...
                    $mes=strftime('%B');
                    ?>
                    <center><label class="parrafo" style="text-align: center;">Se expide en BOGOTA D.C a los <? echo $dia; ?> d&iacute;as del mes de <? echo $mes; ?> de 2023.</label></center>
                    </p>
                    <?
                    } else if($emp=='X1'){
                    ?>
                    ...
                    <ol>
                    <li><label class="parrafo">El premio que se genere tomar&aacute; como base para su liquidaci&oacute;n las compras realizadas de enero 21 de 2023 hasta el 20 de enero de 2024.</label></li> 
                    <li><label class="parrafo">V&aacute;lido &uacute;nicamente por compras de medicamentos de Pestar. La fecha l&iacute;mite para la entrega de premios ser&aacute; marzo de 2024. </label></li> 
                    <li><label class="parrafo">Para la entrega del premio, el cliente debe tener un adecuado manejo del cr&eacute;dito y estar al d&iacute;a en cartera a enero de 2024. </label></li>
