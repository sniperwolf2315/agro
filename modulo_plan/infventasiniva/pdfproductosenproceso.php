    ...
    <body>
        ...
        <div class="centrarancho">
            <div style=" width: 96%; float: left;">
                ...
                <center><label class="titulogrande" style="float: left;">&nbsp;CONSULTA DE PRODUCTOS TERMINADOS EN PROCESO SIN EMPACAR</label></center>
            </div>
            ...
            <tbody>
                ...
                <tr><td style="width: 20%"><label class="titulo1">No.Referencia/Zona:&nbsp;</label></td>
     ...
     if(isset($_POST['buscarProdTermpdf'])){
        ...
        if($resultado && $numero > 0){
            ...
            //$cod=time()+1;
            $nombrearc="informes/productosterminadosueltos.pdf";
       ...
       if(isset($_POST['buscarProdtermxlsx'])){
            ...
            if($resultado && $numero > 0){
                ...
                if(file_exists($miruta)) {
                    ...
                    //titulos
                    $titulo='INFORME DE PRODUCTOS TERMINADOS EN PROCESO SUELTOS: CyMDECORACIONES '.date("d/m/Y");
                    ...
                    $objPHPExcel->setActiveSheetIndex(0)
		                    ...
		                    ->setCellValue('C2', 'REFERENCIA')
                            ->setCellValue('D2', 'CATEGORIA')
                            ->setCellValue('E2', 'SUBCATEGORIA')
		                    ->setCellValue('F2', 'TOTAL UNIDS')
		                    ->setCellValue('G2', 'UNIDS PENDIENTES');
                            //->setCellValue('H2', 'CANT EMPAQUES');
                    ...
                    while($row = $resultado->fetch_array(MYSQLI_NUM)){
                            ...
                            if($resultado2 && $numero2 > 0){
                                ...
                                ->setCellValue('B'.$f, utf8_decode($row[2]))
		                        ->setCellValue('C'.$f, utf8_decode($row2[3]))
		                        ->setCellValue('D'.$f, utf8_decode($row2[17]))
                                ->setCellValue('E'.$f, utf8_decode($row2[18]))
                                ->setCellValue('F'.$f, $row[9])
		                        ->setCellValue('G'.$f, $row[6]);
                                //->setCellValue('H'.$f, $totp);
                                //->setCellValue('I'.$f, utf8_decode($row[11]));
