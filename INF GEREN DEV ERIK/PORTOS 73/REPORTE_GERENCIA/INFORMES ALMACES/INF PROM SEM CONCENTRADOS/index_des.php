...
*/
    ...
    <script language="JavaScript">
        ...
        function Get_date() {
            ...
            // document.getElementById("FechaHasta").value  = anio+"-"+mes_h+"-"+dia;
            // console.log('este es el valor de la fecha', anio+"-"+mes+"-"+dia,' o ',hoy,' ó ',hoy_2);
            // document.getElementById("ERIK").innerHTML=mes_h;
        ...
        function Gere_ven_Al() {
            ...
            // console.log('antes de pasar anio' + anio + '\n mes:' + mes + '\n opc:' + opc + '\n ord' + ord + '\n aniodesde' + anio_desde + '\n mesdesde' + mes_desde + '\n aniohasta' + anio_hasta + '\n meshasta' + mes_hasta + '\n categoria' + cat_consulta);
            ...
            function muestraContenido() {
                if (peticion_http.readyState == 4) {
                    if (peticion_http.status == 200) {
                        ...
                        document.getElementById('respuesta').innerHTML = dato;
                        document.getElementById('Carguesi').style.visibility = 'hidden';
                        // document.getElementById('formuF').innerHTML = '';
        ...
        function Gere_ven() {
            ...
            if ((anio == '' || anio == ' ' || anio == undefined) &&
                ...
                if ((id_period !== 'Por_Fechas')) {
                    ...
                    alert("Digite un año: " + anio);

                    mes = id_period.substring(6, 4);
                    alert("Digite un mes: " + mes);
...
-->
        ...
        <br />
        <div id="respuesta" style="height: 3000px; width: 105%; border: 1px solid #ddd; background: #f1f1f1;overflow-y: scroll; float: left;">
