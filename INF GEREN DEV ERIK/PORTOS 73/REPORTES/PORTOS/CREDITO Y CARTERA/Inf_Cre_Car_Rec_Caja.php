...
if($pasa_query === 0){
        echo "<h5><strong><p style=\"text-align: center;\" class=\"z-depth-1\">No hay facturas para el cliente: ".$cedula."</p></strong></h5>";
}
...
/* $r=$r."  <p style=\"text-align: center;\" class=\"z-depth-1\">Facturas de caja del cliente: ".$cedula."</p>                                 ";
