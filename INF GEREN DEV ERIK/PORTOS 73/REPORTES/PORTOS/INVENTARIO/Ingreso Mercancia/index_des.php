        ...
        */
        ...
        function buscarDatosINVP() {
            ...
            <center>                                                                                                                                                                                               
                ...
                <a class="waves-efect waves-light btn #E67402 orange darken-1" onclick="buscarSalidaMercanciaP();" style="text-transform: capitalize;font-weight: bold;">Salida Mercancia</a>&nbsp;&nbsp;&nbsp;        
...
-->
        ...
        <br />
        <div id="respuesta" style="height: 50%; width: 105%; border: 1px solid #ddd; background: #f1f1f1;overflow-y: scroll; float: left;">
