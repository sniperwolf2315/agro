...
$anio=trim($_GET['a']);
$mes=trim($_GET['m']);
$anio_hasta=trim($_GET['a']);
$mes_hasta=trim($_GET['m']);
...
//$fefin1=$anio.$mes.$dia;
        ...
        <td style=\"font-weight: bold;text-align: left;\" class=\"z-depth-1 white-text text-darken-2\">Facturados</td>
        <td style=\"font-weight: bold;text-align: left;\" class=\"z-depth-1 white-text text-darken-2\">Bonificados</td>
        <td style=\"font-weight: bold;text-align: left;\" class=\"z-depth-1 white-text text-darken-2\">Vencimientos</td>
        <td style=\"font-weight: bold;text-align: left;\" class=\"z-depth-1 white-text text-darken-2\">Lote</td>
        <td style=\"font-weight: bold;text-align: left;\" class=\"z-depth-1 white-text text-darken-2\">Proveedor_Tercero</td>
        <td style=\"font-weight: bold;text-align: left;\" class=\"z-depth-1 white-text text-darken-2\">Procesado</td>
        <td style=\"font-weight: bold;text-align: left;\" class=\"z-depth-1 white-text text-darken-2\">Est_Devolucion</td>
        <td style=\"font-weight: bold;text-align: left;\" class=\"z-depth-1 white-text text-darken-2\">Usuario</td>
        <td style=\"font-weight: bold;text-align: left;\" class=\"z-depth-1 white-text text-darken-2\">Max_Days_Expiration</td>
...
$r=$r."<p style=\"text-align: center;\" class=\"z-depth-1\">Ingreso Mercancia Portos. Fecha Inicio: ".$feini." - hasta: ".$fefin.".</p>";
                    ...
                    if(file_exists($mipath2)) {
                        ...
                        $objWorkSheet = $objPHPExcel->createSheet(0);
                            ...
                            $objWorkSheet->setCellValue('A2', 'No.')
                                ...
                                ->setCellValue('O2', 'facturados')
                                ->setCellValue('P2', 'bonificados')
                                ->setCellValue('Q2', 'vencimientos')
                                ->setCellValue('R2', 'lote')
                                ->setCellValue('S2', 'proveedor_tercero')
                                ->setCellValue('T2', 'procesado')
                                ->setCellValue('U2', 'est_devolucion')
                                ->setCellValue('V2', 'usuario')
                                ->setCellValue('W2', 'max_days_expiration')
            ...
            foreach($datos1 as $dato1){
                ...
                $d14=$dato1['facturados'];
                $d15=$dato1['bonificados'];
                $d16=$dato1['vencimientos'];
                $d17=$dato1['lote'];
                $d18=$dato1['proveedor_tercero'];
                $d19=$dato1['procesado'];
                $d20=$dato1['est_devolucion'];
                $d21=$dato1['usuario'];
                $d22=$dato1['max_days_expiration'];
                $d23=$dato1['tipo'];
