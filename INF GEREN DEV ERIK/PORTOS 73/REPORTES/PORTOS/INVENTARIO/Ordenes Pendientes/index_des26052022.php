...
*/
    ...
    <script language="JavaScript">
        ...
        function buscarSalidaMercanciaPP() {
            document.getElementById('respuesta').style.visibility = 'hidden';
            document.getElementById('Carguesi').style.visibility = 'hidden';
            ...
            <div  style=" width:20%;">
                <table class="input-field col s3">
                    ...
                    <center>
                        <button type="submit" onclick="buscarSalidaMercanciaP();" class="waves-efect waves-light btn #E67402 orange darken-1">
                             BUSCAR
                        </button>
                    </center>
            </div>
        ...
        */
        ...
        function buscarDatosINVP() {
            ...
            <center>                                                                                                                                                                                               
                ...
                <a class="waves-efect waves-light btn #E67402 orange darken-1" onclick="buscarSalidaMercanciaPP();" style="text-transform: capitalize;font-weight: bold;">Salida Mercancia</a>&nbsp;&nbsp;&nbsp;        
