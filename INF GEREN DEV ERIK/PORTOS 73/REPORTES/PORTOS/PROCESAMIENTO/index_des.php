    ...
    <script language="JavaScript">
        ...
        */
        ...
        function buscarPqrP() {
            ...
            texto = texto + '<tr><td>Fecha Inicio: <hr style="width: 90%;"><input type="date" maxlength="2" id="inicial" name="trip-start" value="<?= obtener_fechas_desde(2) ?>" min="2018-01-01" max="2022-12-31"></td>    ';
            texto = texto + '<td>Fecha Fin: <hr style="width: 90%;"><input type="date" maxlength="2" id="fin" name="trip-start" value="<?= obtener_fechas_desde(1) ?>" min="2018-01-01" max="2022-12-31"></td><tr></table>   ';
            ...
            */
            ...
            <div class="input-field col s3" style="width:450px; float: left;">                                                                                                                             
                <table>
                    <tr>
                        <input id="Pqr" value="PQR-" placeholder="PQR-" maxlength="15" type="text" class="validate" style="background-color: white; font-size: 1.4em; text-align: center;" />               
                        <label for="Pqr"></label></tr>                                                                                                                                                                 
                    <tr>
                        <td>
                            Fecha Inicio: 
                            <hr style="width: 90%;"><input type="date" maxlength="2" id="inicial" name="trip-start" value="<?= obtener_fechas_desde(2) ?>" min="2018-01-01" max="2022-12-31">
                        </td>    
                        <td>
                            Fecha Fin: 
                            <hr style="width: 90%;"><input type="date" maxlength="2" id="fin" name="trip-start" value="<?= obtener_fechas_desde(1) ?>" min="2018-01-01" max="2022-12-31">
                        </td>
                    <tr>
                    <tr>
                        <td colspan="12">
        ...
        */
        ...
        function buscarDatosINVP() {
            ...
            <center>                                                                                                                                                                                               
                ...
                <a class="waves-efect waves-light btn #E67402 orange darken-1" onclick="buscarExistenciasMercanciaP();" style="text-transform: capitalize;font-weight: bold;">Existencias Bodega</a>&nbsp;&nbsp;&nbsp; 
