...
*/
    ...
    <script language="JavaScript">
        ...
        function formulario_control(exec_function, txt_title, ruta_reporte) {
        ...
        */
        ...
        function buscarDatosProcesosP() {
            ...
            <center>                                                                                                                                                                                                                                           
                ...
                <a class="waves-efect waves-light btn #E67402 orange darken-1" onclick="Despachos();" style="text-transform: capitalize;font-weight: bold;">Despachos</a>&nbsp;&nbsp;                                                                              
                </center>                                                                                                                                                                                                                                          
                `;
            /*
