...
*/
    ...
    <script language="JavaScript">
        ...
        /* 
                FIXME:ERIK REVISAR LA EJECUCION DE ESTA Function
                TODO: ERIK ESTA TRABAJANDO EN ESTE MODULO PARA EJECUTAR POR FECHAS O PERIODOS 
        */
        ...
        function formulario_control(exec_function, txt_title) {
            ...
            <div  style=" width:20%;">
                <table class="input-field col s3">
                    ...
                    <center>
                        <button type="submit" onclick="${exec_function}();" class="waves-efect waves-light btn #E67402 orange darken-1">
                             BUSCAR
                        </button>
                    </center>
            </div>
                ...
                <table>
                    <tr>
                        <td>
                            Fecha Inicio: 
                            <hr style="width: 90%;">
                                <input type="date" maxlength="2" id="inicial" name="trip-start" value="  " min="2018-01-01" max="2022-12-31">
                            </td>
                        <td>
                            Fecha Fin: 
                            <hr style="width: 90%;">
                                <input type="date" maxlength="2" id="fin" name="trip-start" value="" min="2018-01-01" max="2022-12-31">
                        </td>
                    <tr>
                    <tr>
                        <td colspan="12">
        ...
        function Gere_ven() {
            ...
            // var fec_ini = anio=document.getElementById('FechaActual').value;
        ...
        function buscarPqrP() {
            ...
            texto = `
            <div class="flow-text #439049 green darken-1" style="width:450px; font-size:1.5vw;text-align:center;color:white;">
                Validaci&oacute;n y Empaque
            </div>                                            
            <div class="input-field col s3" style="width:450px; float: left;">                                                                                                                             
                <table>
                    <tr>
                        PQR-<input id="Pqr" placeholder="INGRESE DOCUMENTO" maxlength="15" type="text" class="validate" style="background-color: white; font-size: 1.4em; text-align: center;" />               
                        <label for="Pqr"></label></tr>                                                                                                                                                                 
                    <tr>
                        <td>
                            Fecha Inicio: 
                            <hr style="width: 90%;">
                                <input type="date" maxlength="2" id="inicial" name="trip-start" value="<?= obtener_fechas_desde(2) ?>" min="2018-01-01" max="2022-12-31">
                        </td>    
                        <td>
                            Fecha Fin: 
                            <hr style="width: 90%;">
                                <input type="date" maxlength="2" id="fin" name="trip-start" value="<?= obtener_fechas_desde(1) ?>" min="2018-01-01" max="2022-12-31">
                        </td>
                    <tr>
                    <tr>
                        <td colspan="12">
                            <center>
                                <a class="waves-efect waves-light btn #E67402 orange darken-1" onclick="Pqr_P();">
                                    Generar
                                </a>
                            <center>                                                             
                        </td>
        ...
        */
        ...
        function buscarDatosProcesosP() {
            ...
            */
            ...
            texto = '';
            texto = texto + '<center>';
            texto = texto + '<a class="waves-efect waves-light btn #E67402 orange darken-1" onclick="buscarProcesoActualP();" style="text-transform: capitalize;font-weight: bold;" title="Aún no se define query para este modulo">Proce terminados hoy</a>&nbsp;&nbsp;';
            texto = texto + '<a class="waves-efect waves-light btn #E67402 orange darken-1" onclick="buscarProcesoPendienteP();" style="text-transform: capitalize;font-weight: bold;"title="Aún no se define query para este modulo">Proce Pendientes hoy</a>&nbsp;&nbsp;';
