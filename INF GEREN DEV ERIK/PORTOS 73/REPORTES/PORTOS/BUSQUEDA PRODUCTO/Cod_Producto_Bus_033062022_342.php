...
if ($pro_cod === '' && $bodega === 'TODAS') {
    ...
    $where_and = "and pp.default_code = '$pro_cod' and cast(sw.code as int) = $bodega  ";
} else if ($pro_cod !== '' && $bodega === 'TODAS') {
    $where_and = "and pp.default_code = '$pro_cod'";
}
...
// $query1="select * from product_product  where cast(id as  int) = 10";
