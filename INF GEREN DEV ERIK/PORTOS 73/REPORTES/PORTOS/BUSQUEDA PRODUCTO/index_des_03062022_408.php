    ...
    <script language="JavaScript">
        ...
        */
        ...
        function Busc_Produ() {
            ...
            // texto = texto + '</div>                                                                                                                                                                                                                                                                     ';
            /* var lista_bodegas = {
                "PDES": "PDES - Prueba Destruccion",
                "001": "001 - BODEGA-001-CONTABILIDAD",
                "003": "003 - BODEGA-003-LABORTORIO 73",
                "005": "005 - BODEGA-005-CALLE 73",
                "004": "004 - BODEGA-004-PROMOCIONALES IMPORTADOS Y SUMINISTROS",
                "006": "006 - BODEGA-006-CALIDAD 73 ",
                "007": "007 - BODEGA-007-CALIDAD PORTOS",
                "008": "008 - BODEGA-008-CEDI PORTOS",
                "020": "020 - BODEGA-020-RAPPI BOSQUE",
                "030": "030 - BODEGA-030-RAPPI  ANIMAL FACTOR",
                "040": "040 - BODEGA-040-RAPPI CHIA",
                "050": "050 - BODEGA-050-RAPPI TOBERIN",
            }; */
            var lista_bodegas = [
        ...
        <table>
            ...
            <tr>
                <td>
                    <input id="Producto" onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase();" placeholder="Producto o Cod. Producto" maxlength="15" type="text" class="validate" style="background-color: white; font-size: 1.4em; text-align: center;" />   
