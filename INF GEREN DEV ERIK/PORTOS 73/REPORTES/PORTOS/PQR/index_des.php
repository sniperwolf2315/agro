        ...
        function formulario_control(exec_function, txt_title, ruta_reporte, con_doc = 'no') {
            ...
            if (con_doc === 'si') {
                texto_html = texto_html + `
                    <tr>
                        <input id="Pqr" placeholder="INGRESE DOCUMENTO" value="PQR-"maxlength="15" type="text" class="validate" keyup="${exec_function}('${ruta_reporte}')"   style="background-color: white; font-size: 1.4em; text-align: center;"   />               
                    </tr>
                    O
                `;
            }
