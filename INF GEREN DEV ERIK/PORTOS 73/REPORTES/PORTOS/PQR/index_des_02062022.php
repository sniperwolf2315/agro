...
// $queryCC = "select * from res_partner where ref = '$pqra';"; // ORIGINAL
$queryCC = "select * from res_partner where id = '$pqra';";
...
and (case when left(f.number,4)='FEPO' THEN '008' ELSE (case when left(f.number,4)='FEAL' THEN '005' ELSE (case when left(f.number,2) IN ('FD','01') THEN '008' ELSE '005' end) end) end)='008' 
order by c.name asc
";
