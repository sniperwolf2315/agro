...
$datosOV['user_id'] = 19; //2526
$datosOV['in_charge'] = 19; //2526
//$datosOV['warehouse_id'] = 4;
...
// organiza array con items asi: $lines[0] = array('order_id' => '', 'product_id'=> 83555,'name'=>'test','product_uom_qty' => 100);  
  ...
  if($row['ValorFlete'] > 0){
    $lines[] = array('order_id' => '', 'product_id'=> 375, 'product_uom_qty' => 1, 'InfoAdd' =>'FLETE', 'price_unit' =>$row['ValorFlete'] );
  }
//print_r($datosCLI); print_r($lines); die;
include('_create7000.php');
