...
//$cLink008 = mssql_connect('192.168.6.15', 'sa', '%19Sis60Tem@s17') or die(mssql_get_last_message()); //AZURE10.10.0.5
//mssql_select_db('sqlInventario008',$cLink008);
//$cLink005 = mssql_connect('192.168.6.15', 'sa', '%19Sis60Tem@s17') or die(mssql_get_last_message()); //AZURE10.10.0.5
//mssql_select_db('sqlInventario005',$cLink005);
//SEGURIDAD DE $_post
...
function conectar_sql(){
  $cLink = mssql_connect('192.168.6.15', 'sa', '%19Sis60Tem@s17') or die(mssql_get_last_message()); //AZURE10.10.0.5
  mssql_select_db('SqlFacturas',$cLink);
  echo 'se conecto a esta funcion';
