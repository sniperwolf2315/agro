...
left join stock_quant as sq on p.id=sq.product_id
 where w.code IN('005') and m.state='done' and p.active='true' and sq.location_id='227';";
 */
...
$r=$r."<p style=\"text-align: center;\" class=\"z-depth-1\">Existencias Bodega Almacen.</p>";
//var_dump($datos); 
//echo "<span style='color: black; font-weight: bold;' >INVENTARIO BODEGA</span>";
    ...
    <Strong><a href='Informexls/Informe_Inventario005.xlsx'class=\"z-depth-1 white-text text-darken-2\">Descargar</a><Strong></td>";
    $r=$r . "</tr>";
    $i=1;
        //excel
        $fd=3;
       // $r="Informexls/Informe_Inventario008.xlsx"
        $miruta='Informexls/';
        $nombre_fichero = 'Informe_Inventario005';
        ...
        if(file_exists($miruta)) {
            ...
            if(file_exists($mipath2)) {
                ...
                $objWorkSheet = $objPHPExcel->createSheet(0);
                    ...
                    $objWorkSheet->setTitle("Inventario Bod 005");
                }
        ...
        $objPHPExcel->setActiveSheetIndex(0)
                        ->setCellValue('A1', "INVENTARIO BOD 005");
