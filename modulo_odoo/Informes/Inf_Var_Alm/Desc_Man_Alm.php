...
//echo ("<p style=\"text-align: center;\" class=\"z-depth-1\">anio: ".$anio." mes: ".$mes." opcion: ".$opc." orden: ".$PPA." Item: ".$PPB." fecha: ".$PPC."</p>");//Fecha Inicio: ".$feini." - hasta: ".$fefin.".
                ...
                left join account_invoice f ON sp.name=f.origin--of.invoice_id=f.id and f.state='paid'
                ...
                group by o.name,f.number,p.default_code,p.name_template,ol.promotion,ol.perk,t.name,r.ref
                ...
                foreach($datos as $dato){
                        ...
                        if($idp > 0){
                            $query2 = "select distinct
                                ...
                                --left join discount_filter df on ds.apply_filter_id=df.id
                                left join res_users usr on ol.discount_approver=usr.id
                                left join res_partner pu on usr.partner_id=pu.id
                            --group by o.name, ol.product_id,ds.disc_type,ol.discount_approver,ol.name,pu.name,ol.discount_comments
                            ...
                            $query3 = "SELECT
                                ...
                                FROM sale_order o
                                    ...
                                    left join res_users usr on ol.discount_approver=usr.id
                                    left join res_partner pu on usr.partner_id=pu.id
                                group by ds.name, o.name,ds.disc_type,ol.product_id
                                having o.name='$d0' and ds.disc_type='discount' and ol.product_id='$idp'
                            ";
                            $desc_descuentos="";
                        ...
                        $r=$r."<td style='width: 10%; font-size: 0.5em; border: 1px solid rgb(120,120,120);height: 10px;padding: 5px;'>".$i."</td>
                                    <td style='width: 10%; font-size: 0.5em; border: 1px solid rgb(120,120,120);height: 10px;padding: 5px;'>".$d0."</td>
                                    <td style='width: 10%; font-size: 0.5em; border: 1px solid rgb(120,120,120);height: 10px;padding: 5px;'>".$d1."</td>
                                    <td style='width: 10%; font-size: 0.5em; border: 1px solid rgb(120,120,120);height: 10px;padding: 5px;'>".$d2."</td>
                                    <td style='width: 10%; font-size: 0.5em; border: 1px solid rgb(120,120,120);height: 10px;padding: 5px;'>".$d3."</td>
                                    <td style='width: 10%; font-size: 0.5em; border: 1px solid rgb(120,120,120);height: 10px;padding: 5px;'>".$d4."</td>
                                    ...
                                    <td style='width: 10%; font-size: 0.5em; border: 1px solid rgb(120,120,120);height: 10px;padding: 5px;'>".$desc_descuentos."</td>
                                    <td style='width: 10%; font-size: 0.5em; border: 1px solid rgb(120,120,120);height: 10px;padding: 5px;'>".$desc_cambios."</td>
                                    <td style='width: 10%; font-size: 0.5em; border: 1px solid rgb(120,120,120);height: 10px;padding: 5px;'>".$pdesc."</td>
