...
if(file_exists($miruta)) {
       ...
       //vendeores por areas
        ...
        //VENTA EXTERNA*****************************************************************************************************************
        $area='VENTA EXTERNA';
        $queryv = mssql_query("SELECT * FROM [sqlFacturas].[dbo].[cliVendedor] WHERE SectorLab = '$area' AND ACTIVO = 1 ORDER BY Codigo ASC;", $cLink);
        ...
        while($rowVend = mssql_fetch_array($queryv)){
            ...
            while($rowVendValab = mssql_fetch_array($queryval)){
                ...
                $Porc = iconv('ISO-8859-2', 'UTF-8//IGNORE//TRANSLIT', "=IFERROR(BQ".$fila."*100/BP".$fila.",0)");
            ...
            if($rowVendValab = mssql_fetch_array($querysumCom)){
                ...
                $Porc = iconv('ISO-8859-2', 'UTF-8//IGNORE//TRANSLIT', "=IFERROR(CE".$fila."*100/BP".$fila.",0)");
        ...
        $fila++;
        $area='PEQUE';
        $msg=utf8_encode("PEQUE�OS");
        $fila++;
        $queryv = mssql_query("SELECT * FROM [sqlFacturas].[dbo].[cliVendedor] WHERE left(SectorLab,5) = '$area'  AND ACTIVO = 1 ORDER BY Codigo ASC;", $cLink);
        $num=mssql_num_rows($queryv);
        $tamfilArea=$fila+$num-1;
        $Total=0;
        //combina areas
        ...
        $P=0;
        if($TotalT > 0){
            $P=round(($TotalTotalAlmacen/$TotalT)*100);
        }
        $objWorkSheet->setCellValue('BR'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('BR'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo1 > 0){
            $P=round(($TotalTLab1/$TotalTCuo1)*100);
        }
        ...
        $P=0;
        if($TotalTCuo2 > 0){
            $P=round(($TotalTLab2/$TotalTCuo2)*100);
        }
        ...
        $P=0;
        if($TotalTCuo3 > 0){
            $P=round(($TotalTLab3/$TotalTCuo3)*100);
        }
        ...
        $P=0;
        if($TotalTCuo4 > 0){
            $P=round(($TotalTLab4/$TotalTCuo4)*100);
        }
        ...
        $P=0;
        if($TotalTCuo5 > 0){
            $P=round(($TotalTLab5/$TotalTCuo5)*100);
        }
        ...
        $P=0;
        if($TotalTCuo6 > 0){
            $P=round(($TotalTLab6/$TotalTCuo6)*100);
        }
        ...
        $P=0;
        if($TotalTCuo7 > 0){
            $P=round(($TotalTLab7/$TotalTCuo7)*100);
        }
        ...
        $P=0;
        if($TotalTCuo8 > 0){
            $P=round(($TotalTLab8/$TotalTCuo8)*100);
        }
        ...
        $P=0;
        if($TotalTCuo9 > 0){
            $P=round(($TotalTLab9/$TotalTCuo9)*100);
        }
        ...
        $P=0;
        if($TotalTCuo10 > 0){
            $P=round(($TotalTLab10/$TotalTCuo10)*100);
        }
        ...
        $P=0;
        if($TotalTCuo11 > 0){
            $P=round(($TotalTLab11/$TotalTCuo11)*100);
        }
        ...
        $P=0;
        if($TotalTCuo12 > 0){
            $P=round(($TotalTLab12/$TotalTCuo12)*100);
        }
        ...
        $P=0;
        if($TotalTCuo13 > 0){
            $P=round(($TotalTLab13/$TotalTCuo13)*100);
        }
        ...
        $P=0;
        if($TotalTCuo14 > 0){
            $P=round(($TotalTLab14/$TotalTCuo14)*100);
        }
        ...
        $P=0;
        if($TotalTCuo15 > 0){
            $P=round(($TotalTLab15/$TotalTCuo15)*100);
        }
        ...
        $P=0;
        if($TotalTCuo16 > 0){
            $P=round(($TotalTLab16/$TotalTCuo16)*100);
        }
        ...
        $P=0;
        if($TotalTCuo17 > 0){
            $P=round(($TotalTLab17/$TotalTCuo17)*100);
        }
        ...
        $P=0;
        if($TotalTCuo18 > 0){
            $P=round(($TotalTLab18/$TotalTCuo18)*100);
        }
        ...
        $P=0;
        if($TotalTCuo1I > 0){
            $P=round(($TotalTLab1I/$TotalTCuo1I)*100);
        }
        $objWorkSheet->setCellValue('G'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('G'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo2I > 0){
            $P=round(($TotalTLab2I/$TotalTCuo2I)*100);
        }
        $objWorkSheet->setCellValue('J'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('J'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo3I > 0){
            $P=round(($TotalTLab3I/$TotalTCuo3I)*100);
        }
        $objWorkSheet->setCellValue('M'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('M'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo4I > 0){
            $P=round(($TotalTLab4I/$TotalTCuo4I)*100);
        }
        $objWorkSheet->setCellValue('P'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('P'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo5I > 0){
            $P=round(($TotalTLab5I/$TotalTCuo5I)*100);
        }
        $objWorkSheet->setCellValue('S'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('S'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo6I > 0){
            $P=round(($TotalTLab6I/$TotalTCuo6I)*100);
        }
        $objWorkSheet->setCellValue('V'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('V'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo7I > 0){
            $P=round(($TotalTLab7I/$TotalTCuo7I)*100);
        }
        $objWorkSheet->setCellValue('Y'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('Y'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo8I > 0){
            $P=round(($TotalTLab8I/$TotalTCuo8I)*100);
        }
        $objWorkSheet->setCellValue('AB'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('AB'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo9I > 0){
            $P=round(($TotalTLab9I/$TotalTCuo9I)*100);
        }
        $objWorkSheet->setCellValue('AE'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('AE'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo10I > 0){
            $P=round(($TotalTLab10I/$TotalTCuo10I)*100);
        }
        $objWorkSheet->setCellValue('AK'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('AK'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo11I > 0){
            $P=round(($TotalTLab11I/$TotalTCuo11I)*100);
        }
        $objWorkSheet->setCellValue('AN'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('AN'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo12I > 0){
            $P=round(($TotalTLab12I/$TotalTCuo12I)*100);
        }
        $objWorkSheet->setCellValue('AT'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('AT'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo13I > 0){
            $P=round(($TotalTLab13I/$TotalTCuo13I)*100);
        }
        $objWorkSheet->setCellValue('AW'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('AW'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo14I > 0){
            $P=round(($TotalTLab14I/$TotalTCuo14I)*100);
        }
        $objWorkSheet->setCellValue('AZ'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('AZ'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo15I > 0){
            $P=round(($TotalTLab15I/$TotalTCuo15I)*100);
        }
        $objWorkSheet->setCellValue('BF'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('BF'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo16I > 0){
            $P=round(($TotalTLab16I/$TotalTCuo16I)*100);
        }
        $objWorkSheet->setCellValue('BI'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('BI'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo17I > 0){
            $P=round(($TotalTLab17I/$TotalTCuo17I)*100);
        }
        $objWorkSheet->setCellValue('BL'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('BL'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo18I > 0){
            $P=round(($TotalTLab18I/$TotalTCuo18I)*100);
        }
        $objWorkSheet->setCellValue('BO'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('BO'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo1O > 0){
            $P=round(($TotalTLab1O/$TotalTCuo1O)*100);
        }
        $objWorkSheet->setCellValue('G'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('G'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo2O > 0){
            $P=round(($TotalTLab2O/$TotalTCuo2O)*100);
        }
        $objWorkSheet->setCellValue('J'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('J'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo3O > 0){
            $P=round(($TotalTLab3O/$TotalTCuo3O)*100);
        }
        $objWorkSheet->setCellValue('M'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('M'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo4O > 0){
            $P=round(($TotalTLab4O/$TotalTCuo4O)*100);
        }
        $objWorkSheet->setCellValue('P'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('P'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo5O > 0){
            $P=round(($TotalTLab5O/$TotalTCuo5O)*100);
        }
        $objWorkSheet->setCellValue('S'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('S'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo6O > 0){
            $P=round(($TotalTLab6O/$TotalTCuo6O)*100);
        }
        $objWorkSheet->setCellValue('V'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('V'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo7O > 0){
            $P=round(($TotalTLab7O/$TotalTCuo7O)*100);
        }
        $objWorkSheet->setCellValue('Y'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('Y'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo8O > 0){
            $P=round(($TotalTLab8O/$TotalTCuo8O)*100);
        }
        $objWorkSheet->setCellValue('AB'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('AB'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo9O > 0){
            $P=round(($TotalTLab9O/$TotalTCuo9O)*100);
        }
        $objWorkSheet->setCellValue('AE'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('AE'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo10O > 0){
            $P=round(($TotalTLab10O/$TotalTCuo10O)*100);
        }
        $objWorkSheet->setCellValue('AK'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('AK'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo11O > 0){
            $P=round(($TotalTLab11O/$TotalTCuo11O)*100);
        }
        $objWorkSheet->setCellValue('AN'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('AN'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo12O > 0){
            $P=round(($TotalTLab12O/$TotalTCuo12O)*100);
        }
        $objWorkSheet->setCellValue('AT'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('AT'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo13O > 0){
            $P=round(($TotalTLab13O/$TotalTCuo13O)*100);
        }
        $objWorkSheet->setCellValue('AW'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('AW'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo14O > 0){
            $P=round(($TotalTLab14O/$TotalTCuo14O)*100);
        }
        $objWorkSheet->setCellValue('AZ'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('AZ'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo15O > 0){
            $P=round(($TotalTLab15O/$TotalTCuo15O)*100);
        }
        $objWorkSheet->setCellValue('BF'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('BF'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo16O > 0){
            $P=round(($TotalTLab16O/$TotalTCuo16O)*100);
        }
        $objWorkSheet->setCellValue('BI'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('BI'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo17O > 0){
            $P=round(($TotalTLab17O/$TotalTCuo17O)*100);
        }
        $objWorkSheet->setCellValue('BL'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('BL'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        $P=0;
        if($TotalTCuo18O > 0){
            $P=round(($TotalTLab18O/$TotalTCuo18O)*100);
        }
        $objWorkSheet->setCellValue('BO'.$fila, $P."%");
        $objPHPExcel->getActiveSheet()->getStyle('BO'.$fila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        ...
        while($t<=$ct){
            switch($Laboratoriostot[$t]){
                case 'Ferreteria':
                    ...
                    //PORCENTAJE VENTA TOTAL INDIVICUAL DERECHA
                    $Porc = iconv('ISO-8859-2', 'UTF-8//IGNORE//TRANSLIT', "=IFERROR(F".$fila."*100/E".$fila.",0)");
                ...
                case 'Varios':
                    ...
                    //PORCENTAJE VENTA TOTAL INDIVICUAL DERECHA
                    $Porc = iconv('ISO-8859-2', 'UTF-8//IGNORE//TRANSLIT', "=IFERROR(I".$fila."*100/H".$fila.",0)");
                ...
                case 'Concentrados':
                    ...
                    //PORCENTAJE VENTA TOTAL INDIVICUAL DERECHA
                    $Porc = iconv('ISO-8859-2', 'UTF-8//IGNORE//TRANSLIT', "=IFERROR(L".$fila."*100/K".$fila.",0)");
                ...
                case 'Pets':
                    ...
                    //PORCENTAJE VENTA TOTAL INDIVICUAL DERECHA
                    $Porc = iconv('ISO-8859-2', 'UTF-8//IGNORE//TRANSLIT', "=IFERROR(O".$fila."*100/N".$fila.",0)");
                ...
                case 'Ganaderia':
                    ...
                    //PORCENTAJE VENTA TOTAL INDIVICUAL DERECHA
                    $Porc = iconv('ISO-8859-2', 'UTF-8//IGNORE//TRANSLIT', "=IFERROR(R".$fila."*100/Q".$fila.",0)");
                ...
                case 'Insecticidas':
                    ...
                    //PORCENTAJE VENTA TOTAL INDIVICUAL DERECHA
                    $Porc = iconv('ISO-8859-2', 'UTF-8//IGNORE//TRANSLIT', "=IFERROR(U".$fila."*100/T".$fila.",0)");
                ...
                case 'Invet':
                    ...
                    //PORCENTAJE VENTA TOTAL INDIVICUAL DERECHA
                    $Porc = iconv('ISO-8859-2', 'UTF-8//IGNORE//TRANSLIT', "=IFERROR(X".$fila."*100/W".$fila.",0)");
                ...
                case 'Icofarma':
                    ...
                    //PORCENTAJE VENTA TOTAL INDIVICUAL DERECHA
                    $Porc = iconv('ISO-8859-2', 'UTF-8//IGNORE//TRANSLIT', "=IFERROR(AA".$fila."*100/Z".$fila.",0)");
                ...
                case 'Comervet':
                    ...
                    //PORCENTAJE VENTA TOTAL INDIVICUAL DERECHA
                    $Porc = iconv('ISO-8859-2', 'UTF-8//IGNORE//TRANSLIT', "=IFERROR(AD".$fila."*100/AC".$fila.",0)");
                ...
                case 'Gabrica':
                    ...
                    //PORCENTAJE VENTA TOTAL INDIVICUAL DERECHA
                    $Porc = iconv('ISO-8859-2', 'UTF-8//IGNORE//TRANSLIT', "=IFERROR(AJ".$fila."*100/AI".$fila.",0)");
                ...
                case 'Biostar':
                    ...
                    //PORCENTAJE VENTA TOTAL INDIVICUAL DERECHA
                    $Porc = iconv('ISO-8859-2', 'UTF-8//IGNORE//TRANSLIT', "=IFERROR(AM".$fila."*100/AL".$fila.",0)");
                 ...
                 case 'Coaspharma':
                    ...
                    //PORCENTAJE VENTA TOTAL INDIVICUAL DERECHA
                    $Porc = iconv('ISO-8859-2', 'UTF-8//IGNORE//TRANSLIT', "=IFERROR(AS".$fila."*100/AR".$fila.",0)");
                 ...
                 case 'Importados':
                    ...
                    //PORCENTAJE VENTA TOTAL INDIVICUAL DERECHA
                    $Porc = iconv('ISO-8859-2', 'UTF-8//IGNORE//TRANSLIT', "=IFERROR(AV".$fila."*100/AU".$fila.",0)");
                 ...
                 case 'Intervet':
                    ...
                    //PORCENTAJE VENTA TOTAL INDIVICUAL DERECHA
                    $Porc = iconv('ISO-8859-2', 'UTF-8//IGNORE//TRANSLIT', "=IFERROR(AY".$fila."*100/AX".$fila.",0)");
                 ...
                 case 'LineaAgil':
                    ...
                    //PORCENTAJE VENTA TOTAL INDIVICUAL DERECHA
                    $Porc = iconv('ISO-8859-2', 'UTF-8//IGNORE//TRANSLIT', "=IFERROR(BE".$fila."*100/BD".$fila.",0)");
                 ...
                 case 'LineaAgilImportados':
                    ...
                    //PORCENTAJE VENTA TOTAL INDIVICUAL DERECHA
                    $Porc = iconv('ISO-8859-2', 'UTF-8//IGNORE//TRANSLIT', "=IFERROR(BH".$fila."*100/BG".$fila.",0)");
                 ...
                 case 'LaboratoriosBai':
                    ...
                    //PORCENTAJE VENTA TOTAL INDIVICUAL DERECHA
                    $Porc = iconv('ISO-8859-2', 'UTF-8//IGNORE//TRANSLIT', "=IFERROR(BK".$fila."*100/BJ".$fila.",0)");
                 ...
                 case 'Tecnocalidad':
                    ...
                    //PORCENTAJE VENTA TOTAL INDIVICUAL DERECHA
                    $Porc = iconv('ISO-8859-2', 'UTF-8//IGNORE//TRANSLIT', "=IFERROR(BN".$fila."*100/BM".$fila.",0)");
...
for($to=0;$to<=$cantidadTeleoperadores-1 ;$to++){
    ...
    //=SI.ERROR(BQ121*100/BP121;333)
        //BQ205*100/BP205;
        //$nose1=("=BQ".($filanose-2)."*100/BP".($filanose-2));
        $nose1= iconv('ISO-8859-2', 'UTF-8//IGNORE//TRANSLIT', "=IFERROR(BQ".($filanose-2)."*100/BP".($filanose-2).",0)");
        $filanose1=$filanose-2;
        $objWorkSheet->setCellValue('BR'.$filanose1, $nose1);
        
        $filanose2=$filanose-1;
        //$nose2=("=BQ".($filanose-1)."*100/BP".($filanose-1));
        $nose2= iconv('ISO-8859-2', 'UTF-8//IGNORE//TRANSLIT', "=IFERROR(BQ".($filanose-1)."*100/BP".($filanose-1).",0)");
        $objWorkSheet->setCellValue('BR'.$filanose2, $nose2);
        
        $nose3= iconv('ISO-8859-2', 'UTF-8//IGNORE//TRANSLIT', "=IFERROR(BQ".($filanose)."*100/BP".($filanose).",0)");
        //$nose3=("=BQ".($filanose)."*100/BP".($filanose));
