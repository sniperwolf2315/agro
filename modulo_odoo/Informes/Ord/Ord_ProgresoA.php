...
$r=$r."<p style=\"text-align: center;\" class=\"z-depth-1\">Ordenes en Estado Pendiente. Compras Pendientes Por Entregar a Corte: ".$fechaActual."</p>";//Fecha Inicio: ".$feini." - hasta: ".$fefin.".
        ...
        <a href='Informexls/ORDENES_PROGRESO_005.xlsx' class=\"z-depth-1 white-text text-darken-2\">Descargar</a><Strong></td>";
        $r=$r."</tr>";
...
$i=1;
                ...
                $miruta='../Informexls/';
                $nombre_fichero = 'ORDENES_PROGRESO_005';
            ...
            foreach($datos1 as $dato1){
                ...
                //tr style='background-color: $color; font-size: 0.5em;
