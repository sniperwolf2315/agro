...
SELECT 
    rp.id as id_cliente,
    rp.display_name as nom_completo,
    rp.email as email,
    rp.credit_limit as lim_credito,
    rp.tipo_tercero as tip_tercerp,
    cpq.name as pregunta,
    cpa.name as respuesta,
...
if( $cantP1 ===0 ){
     echo "<h5><strong><p style=\"text-align: center;\" class=\"z-depth-1\">No hay datos para mostrar en perfil del cliente:$cedula </p> </strong> </h5> ";
     return;
}
...
$r = $r . "
        <p style=\"text-align: center;\" class=\"z-depth-1\">Perfil del cliente: " . $cedula . "</p>                         
