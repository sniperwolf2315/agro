...
if ($pasa_query === 0) {
    echo "<h5><strong>  <p style=\"text-align: center;\" class=\"z-depth-1\">No hay dato en esta consulta para el cliente: " . $cedula . "</p> </strong> </h5>";
    return;
}
...
$r = $r . "
        <p style=\"text-align: center;\" class=\"z-depth-1\">Facturas de venta del cliente: " . $cedula . "</p>                     
