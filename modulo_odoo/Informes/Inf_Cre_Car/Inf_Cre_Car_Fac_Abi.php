...
$query1 = "
    select ai.number as nom_fac,
    ai.internal_number as num_factura,
    ai.state as estado,
    ai.type as tip_trans,
    ai.date_invoice as fecha,
    ai.amount_untaxed as subtotal,
    ai.amount_tax as impuesto,
    ai.amount_total as total,
    ai.residual as saldo
    from 
        res_partner as rp
...
if ($pasa_query === 0) {
    echo "<h5><strong><p style=\"text-align: center;\" class=\"z-depth-1\">No hay facturas en estado abierto para el cliente: " . $cedula . "</p></strong></h5>";
    return;
};

$r = $r . "
        <p style=\"text-align: center;\" class=\"z-depth-1\">Facturas en Estado Abierto del cliente: " . $cedula . "</p>                 
...
";
            ...
            /* ## ESTE FOR ALIEMNTA LA TABLA PHP CON LOS RESULTADOS DE LA CONSULTA  */
