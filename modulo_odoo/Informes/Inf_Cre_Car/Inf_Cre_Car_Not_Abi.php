...
select 
    ...
    ai.number as titulo_nt,
    ai.name as titulo_2,
    ai.internal_number as numero_fact,
    ai.type as tipo,
    ai.origin as origen,
    ai.state as estado,
    ...
    aj.name as comprobante,
    ai.move_name as secuen_asiento
from 
...
if ($pasa_query === 0) {
    echo "<h5><strong> <p style=\"text-align: center;\" class=\"z-depth-1\">No hay notas en estado abierto para el cliente: " . $cedula . "</p> </strong> </h5>   ";
    return;
}

$r = $r . "
<p style=\"text-align: center;\" class=\"z-depth-1\">Notas en Estado Abierto: " . $cedula . "</p>                        
