...
$query1="select rp.id as buscar,block as cred_cloque, check_due as bloq_por_fac_vendida,credit_limit as lim_cre
...
where rp.ref='".$cedula."' and rp.customer='true' and rpc.name='CREDITO';";
$resultado1= $Conn->prepare($query1);
$resultado1->execute();
$datos1=$resultado1->fetchAll();
$r=$r."<p style=\"text-align: center;\" class=\"z-depth-1\">Cartera Por Cliente: ".$cedula."</p>";
    $i=1;
...
foreach($datos1 as $dato1){
        ...
        $dc=$dato1['buscar'];
            ...
            $query3="SELECT l.partner_id as id_cliente, a.type as tipo, SUM(l.debit-l.credit) as resultado FROM account_move_line l
            LEFT JOIN account_account a ON (l.account_id=a.id)
            WHERE a.type IN ('receivable','payable') AND l.partner_id IN ('".$dc."') AND l.reconcile_id IS NULL GROUP BY l.partner_id, a.type;";
