    ...
    <script language="JavaScript">
        ...
        function Cod_Producto_Bus() {
            ...
            if (Bodega == "" && Cod_Pro_Bus.length === 0) {
                ...
                alert("¡Por favor seleccionar un codigo de producto o nombre!");
                return false;
            }
        ...
        function Inf_Mes_Com() {
            ...
            if (ejecutar_por === 'anio_mes') {
                ...
                tipo_consulta = 'rangos';
            } else if (ejecutar_por !== '' || ejecutar_por !== 'Por_Fechas' || ejecutar_por !== 'anio_mes') {
        ...
        SELECT Tipo_Cuota, Col_Campo_Buscar, Des_Campo_Buscar, Sectorlab FROM [sqlFacturas].[dbo].[facTipoCuota] WHERE Sectorlab!='-';
