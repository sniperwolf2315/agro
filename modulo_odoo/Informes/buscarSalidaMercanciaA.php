...
where so.name is not null and sw.code='005';";
$resultado= $Conn->prepare($query);
$resultado->execute();
$datos=$resultado->fetchAll();
$cantP=count($datos);
$r=$r."<p style=\"text-align: center;\" class=\"z-depth-1\">Salida Mercancia Almacen.</p>";
    $i=1;
    $r=$r."<table style=\"border: 1px solid #000; width:100%; \" class=\"#439049 green darken-1\">";
        ...
        <td><Strong><a href='Informexls/SALIDA_MERCANCIA_005.xlsx' class=\"z-depth-1 white-text text-darken-2\">Descargar</a><Strong></td>";
        $r=$r . "</tr>";
    
    $fd=3;
       // $r="Informexls/Informe_Inventario008.xlsx"
        $miruta='Informexls/';
        $nombre_fichero = 'SALIDA_MERCANCIA_005';
        ...
        if(file_exists($miruta)) {
            ...
            if(file_exists($mipath2)) {
                ...
                $objWorkSheet = $objPHPExcel->createSheet(0);
                    ...
                    $objWorkSheet->setTitle("SALIDA MERCANCIA 005");
                }
        ...
        $objPHPExcel->setActiveSheetIndex(0)
                        ->setCellValue('A1', "SALIDA MERCANCIA 005");
        ...
        $d5=$dato['ubi_bodega'];
            ...
            foreach($datos2 as $dato2){
                        ...
                        $d19=$dato2['transportador'];
                            ...
                            <td style='width: 19%; font-size: 0.5em; background-color: azure; border: 1px solid rgb(220,220,220);height: 10px;padding: 0px;'></td>";
                            $r=$r."</tr>";
        //EXCEL
            $objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('A'.$fd, $i)            
