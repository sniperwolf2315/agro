...
if ($_SESSION['usuARio'] === '' || $_SESSION['usuARio'] === ' ' || empty($_SESSION['usuARio'])) {
    header("location:user_conect_odoo.php");
    php_function_boton_login();
    die;
}
    ...
    <script language="JavaScript">
        ...
        function Popup(valor) {
            ...
            if (popUp == null || typeof(popUp) == 'undefined') {
                // popup_swal('Por favor deshabilita el bloqueador de ventanas emergentes.');
                popup_swal('Por favor deshabilita el bloqueador de ventanas emergentes.');
            } else {
                popUp.focus();
            }
            ...
            function muestraContenido() {
                if (peticion_http.readyState == 4) {
                    if (peticion_http.status == 200) {
                        ...
                        // popup_swal('Informe generado correctamente. Puede descargarlo mediante el link');
                        popup_swal('Informe generado correctamente. Puede descargarlo mediante el link');
                    }
                }
            }
        ...
        function buscarDatos1() {
            ...
            var periodo = ano + mes;
            if (mes.length < 2) {
                // popup_swal("El mes debe tener min 2 cifras");
                popup_swal('El mes debe tener min 2 cifras');
                return false;
            }
            if (ano.length < 4) {
                // popup_swal("El a�o debe tener min 4 cifras");
                popup_swal('El año debe tener min 4 cifras');
                return false;
            }
            if (periodo != "") {
                ...
                function muestraContenido() {
                    if (peticion_http.readyState == 4) {
                        if (peticion_http.status == 200) {
                            var dato = peticion_http.responseText;
                            // popup_swal('COMPLETADO..');
                            popup_swal('','COMPLETADO','success');
                ...
                // popup_swal('Digite a�o y mes');
                popup_swal('Digite año y mes');
        ...
        function Guardar_Vista() {
            ...
            if (periodo != "") {
                ...
                // popup_swal('Seleccione mes, a�o y vista');
                popup_swal('Seleccione mes, a�o y vista');
            }
        }
        ...
        function Guardar_Grupo() {
            ...
            if (grupo == "") {
                // popup_swal('Digite el Grupo');
                popup_swal('Digite el Grupo');
                return false;
            }
            if (manejador == "") {
                // popup_swal('Seleccione un manejador');
                popup_swal('Seleccione un manejador');
                return false;
            }
            if (categoria == "") {
                // popup_swal('Digite una categoria');
                popup_swal('Digite una categoria');
                return false;
            }
        ...
        function buscarIngresoMercanciaP() {
            ...
            if (ejecutar_por === '' || ejecutar_por === null || ejecutar_por === undefined) { //VALIDAR SI LA OPCION TIENE VALOR VACIO
                // popup_swal("¡Por Favor seleccione un metodo de ejecución!");
                popup_swal("¡Por Favor seleccione un metodo de ejecución!");
                return;
        ...
        function Ord_pendientesP() {
            ...
            if (tiempo == "") {
                // popup_swal("Seleccione una Busqueda");
                popup_swal("Seleccione una Busqueda");
                return;
            }
        ...
        function buscarIngresoMercanciaA() {
            ...
            */
            ...
            var anio, mes;
            if (anio == "") {
                // popup_swal("Digite un a�o");
                popup_swal("Digite un a�o");
                return false;
            }
            if (mes == "") {
                // popup_swal("Digite un mes");
                popup_swal("Digite un mes");
                return false;
            }
            document.body.style.cursor = 'wait';
        ...
        function Cre_Car_perfileria() {
            ...
            if (cedu === '') {
                // popup_swal("Por Favor ingrese un documento válido");
                popup_swal("Por Favor ingrese un documento válido");
                return
            }
        ...
        /* TODO: estamos trabajando en esto erik */
        ...
        function buscarExistenciasMercanciaP() {
           ...
           dom_por_fechas = document.getElementById('Por_Fechas').value;
            ...
            if (dom_por_fechas === '') {
                popup_swal("¡Por favor ingresar un tipo de consulta!");
                return;
            } else {
        ...
        function campos_en_blanco() {
            var existe = existe_elemento(document.getElementById('Pqr'));
            if (existe) {
        ...
        function formulario_control(exec_function, txt_title, ruta_reporte, con_doc, sede) {
            document.getElementById('sub_route_1').innerHTML = '/ ' + txt_title.toLowerCase();
            document.getElementById('respuesta').style.visibility = 'hidden';
            document.getElementById('Carguesi').style.visibility = 'hidden';
            ...
            texto_html = `
            <div class="flow-text #439049 green darken-1" style="width:70%; font-size:1.5vw;text-align:center;color:white;">
                ${txt_title }
            </div>
            <div  style=" width:70%;">
            ...
            texto_html = texto_html + ` 
                    ...
                    <center>
                        <button type="submit" onclick="${exec_function}('${ruta_reporte}','${sede}' );" class="waves-efect waves-light btn #E67402 orange darken-1">
                             BUSCAR
                        </button>
                    </center>
            </div>
        ...
        function consultar_informe(ruta_reporte, sede) {
            ...
            var fec_desde = document.getElementById('desde').value;
            var fec_hasta = document.getElementById('hasta').value;
            var pqr_val = existe_elemento(document.getElementById('Pqr'));


            document.getElementById('respuesta').style.visibility = 'visible';
            if (pqr_val) {
                pqr_val = document.getElementById('Pqr').value;
            } else {
                pqr_val = false;
            }


            if ((pqr_val === '' || pqr_val === false || pqr_val.length <= 4) && option_period === '') {
                // popup_swal("Por favor ingresar un No. de documento o una opción de la lista.");
                popup_swal("Por favor ingresar un No. de documento o una opción de la lista.");
                return;
            } else if (pqr_val !== 'PQR-' && pqr_val.length >= 4 || pqr_val === true) {
                pqr_val = pqr_val;
                tipo_consulta = 'pqr';
            ...
            } else if (option_period !== 'Por_Fechas' && option_period !== ' ' && option_period.length > 0) {
            ...
            if (tipo_consulta === 'rangos') {
                peticion_http.open('POST', ruta_reporte_final.toString() + '.php?a=' + anio_d + '&m=' + mes_d + '&d=' + dia_d + '&ah=' + anio_h + '&mh=' + mes_h + '&dh=' + dia_h + '&tc=' + tipo_consulta + '&sede=' + sede, true);
            } else if (tipo_consulta === 'normal' && (pqr_val === '' || pqr_val === false)) {
                peticion_http.open('POST', ruta_reporte_final.toString() + '.php?a=' + anio_d + '&m=' + mes_d + '&tc=' + tipo_consulta + '&sede=' + sede, true);
            } else if (tipo_consulta === 'pqr' && (pqr_val !== '' || pqr_val === true) || pqr_val.length > 0) {
                peticion_http.open('POST', ruta_reporte_final.toString() + '.php?p=' + pqr_val + '&tc=' + tipo_consulta + '&sede=' + sede, true);
            } else {
        ...
        function buscarSalidaMercanciaP() {
            ...
            document.getElementById('respuesta').style.visibility = 'hidden';
            document.getElementById('Carguesi').style.visibility = 'visible';
            document.getElementById('sub_route_1').innerHTML = '/ Salida mercancia';
            ...
            if (dom_por_fechas === '') {
                popup_swal("Por elija un periodo o por fechas");
                return;
                ...
                popup_swal("no hay parametros validos");
                return;
            }
            document.getElementById('estado').innerHTML = '<center><img src="img/escribe.gif" width="180px" height="180px"></center>';
            document.body.style.cursor = 'wait';
        ...
        function Cod_Producto_Bus() {
            ...
            if (Bodega == "" && Cod_Pro_Bus.length === 0) {
                popup_swal("¡Por favor llenar los campos bodega  y producto !");
                return false;
            } else if (Bodega == "") {
                popup_swal("¡Por favor seleccionar una bodega!");
                return false;
            } else if (Cod_Pro_Bus.length === 0) {
                popup_swal("¡Por favor seleccionar un codigo de producto o nombre!");
                return false;
            }
        ...
        function Inf_Mes_Com() {
            ...
            if (ejecutar_por == "" || ejecutar_por == undefined) {
                // popup_swal("Por favor elejir un periodo ");
                swal( "Por favor elija un periodo");
                return;
            }
            if (ejecutar_por === 'anio_mes') {
                if (anio == "" && mes == "" && ejecutar_por == "") {
                    popup_swal("Por favor diligenciar Año y Mes");
                    return;
                } else if (mes == "") {
                    popup_swal("Digite un mes");
                    return;
        ...
        function Inf_Mes_Com_InformeXls(periodolab) {
            ...
            document.body.style.cursor = 'wait';
            var periodo = periodolab;
            var dias_periodo = prompt(`Dias festivos a descontar del periodo ${periodo} ` );
            dias_periodo = (dias_periodo ===' ')? 30 : dias_periodo ; 
            
           
            if (window.XMLHttpRequest) { // Obtener la instancia del objeto XMLHttpRequest
                peticion_http = new XMLHttpRequest();
            } else if (window.ActiveXObject) {
                peticion_http = new ActiveXObject("Microsoft.XMLHTTP");
            }
            ...
            peticion_http.onreadystatechange = muestraContenido;
            // Realizar peticion HTTP
            peticion_http.open('POST', 'mescom/cargardatosxls_des.php?periodo=' + periodo +'&dias='+dias_periodo , true);
            peticion_http.send(null);
            ...
            function muestraContenido() {
                ...
                if (peticion_http.readyState == 4) {
                    if (peticion_http.status == 200) {
                        ...
                        document.getElementById('estado').innerHTML = '';
                        document.getElementById('respuesta').innerHTML = dato;
                        popup_swal('Informe generado correctamente. Puede descargarlo mediante la opción DESCARGAR INFORME');
        ...
        function CREDITOCAR() {
            let texto = '';
            document.getElementById('sub_route').innerHTML = '/ credito y cartera';
            ...
            texto = texto + `
            <div class="flow-text gray" style="font-size:1.5vw;text-align:left; color: #439049;"><b>CATEGORIZACION CREDITO Y CARTERA</b></div>                     
            <a class="waves-efect waves-light btn #E67402 orange darken-1" onclick="Boto_cartera();">INFORME CATEGORIZACION CREDITO Y CARTERA</a>&nbsp;&nbsp;&nbsp;
            `;
        ...
        function Gerencia_Ven() {
            ...
            texto = '';
            texto = texto + '<div class="flow-text gray" style="font-size:1.5vw;text-align:left; color: #439049;"><b><span class="info_route">Gerencia / </span> <span class="info_route">COMPRAS Y VENTAS</span> <span id="sub_route" name="sub_route" class="info_route" ></span> <span id="sub_route_1" name="sub_route_1" class="info_route" ></span> </b>   </div>';
        ...
        function Gerencia_Mes_Com() {
            ...
            document.getElementById('sub_route').innerHTML = ' / Informe mes comercial';
            document.getElementById('sub_route_1').innerHTML = '';
            document.getElementById('parametros').innerHTML = '';
            document.getElementById('frmbuscar').innerHTML = '';
            document.getElementById('respuesta').innerHTML = '';
            document.getElementById('estado').innerHTML = '';
            ...
            <br>
            `;
            texto = texto +'<br> <button type="button" class="btn btn-outline-info" onclick="excel_des()">Calcular </button>';
        ...
        function Gerencia_Ven_F() {
            ...
            document.getElementById('parametros').innerHTML = '';
            document.getElementById('sub_route').innerHTML = '/ Informe compras y ventas';
            document.getElementById('sub_route_1').innerHTML = '';
            document.getElementById('respuesta').innerHTML = '';
            document.getElementById('estado').innerHTML = '';
        ...
        function Gerencia_Ven_A() {
            var texto = '';
            document.getElementById('sub_route').innerHTML = '/ Informes varios alamacén';
        ...
        function Geren_Ven_Al() {
            ...
            if (existe_elemento(document.getElementById('sub_route_1'))) {
                document.getElementById('sub_route_1').innerHTML = ' / Sem prom concentrados';
                console.log('si existe');
            } else {
                console.log('no existe el dom');
            }
            ...
            texto = `
            <div class="flow-text #439049 green darken-1" style="width:50%; font-size:1.5vw;text-align:center;color:white;">
        ...
        function DescuentosManA() {
            ...
            if (existe_elemento(document.getElementById('sub_route_1'))) {
                document.getElementById('sub_route_1').innerHTML = ' / Dctos. manuales';
            }


            /*           # COFIGO ORIGINAL
                TODO: No borrar por ahora
                texto = texto + '<div class="flow-text #439049 green darken-1" style="width:50%; font-size:1.5vw;text-align:center;color:white;">Descuentos Manuales</div>';
        ...
        function Gere_ven_Al() {
            ...
            if (ord === '' && ejecutar_por === '') {
                popup_swal('Por favor diligenciar la orden o Ejecutar por...');
                return
            } else {
        ...
        function Gere_descman_Al() {
            ...
            if ((ord === '' || ord.length === 0) && ejecutar_por === '') {
                popup_swal("Por favor digitar una orden o  codigo  ó \nselccionar ejecutar por");
                return
            } else {
                ...
                if (ejecutar_por === 'anio_mes') {
                    ...
                    if (anio === '') {
                        popup_swal("Por favor especificar un año");
                        return
                    } else if (mes === '') {
                        popup_swal("Por favor especificar un mes");
                        return
                    } else {
                        anio = anio;
                        mes = mes;
        ...
        function Gerencia_Com_F() {
            ...
            texto = texto + '<div class="flow-text #439049 green darken-1" style="width:70%; font-size:1.5vw;text-align:center;color:white;">Ingreso Mercancia</div>';

            texto = texto + '<div class="input-field col s3" style="width:70%;">';
        ...
        function buscarSeparacionAlistamientoP() {
            document.getElementById('respuesta').innerHTML = '';
            document.getElementById('frmbuscar').innerHTML = '';
            document.getElementById('sub_route_1').innerHTML = '/ Separación y alistamiento';
            texto = '';
            ...
            <div class="input-field col s3" style="width:50%; float: left;">                                                                                                     
                <table>
                    <tr>
                        <?php
                        id_periodo(0);
        ...
        function separacionAlistaP() {
            ...
            if (option_period === '') {
                popup_swal("Por favor elegir una opción de consulta.");
                return;
            } else if (option_period === 'Por_Fechas') {
                anio_d = clear_date(fec_desde, 'anio');
                mes_d = clear_date(fec_desde, 'mes');
        ...
        function ValidacionEmpaP() {
            ...
            if (inicial == "") {
                popup_swal("Seleccione una fecha inicial");
                return false;
            }
            if (fin == "") {
                popup_swal("Seleccione una fecha final");
                return false;
            }
            document.getElementById('estado').innerHTML = '<center><img src="img/escribe.gif" width="180px" height="180px"></center>';
            document.body.style.cursor = 'wait';
        ...
        function Gere_ven() {
            ...
            if ((anio == '' || anio == ' ' || anio == undefined) &&
                ...
                if ((id_period !== 'Por_Fechas')) {
                    ...
                    // popup_swal('consulta ' + this.consul + '\n' + 'Año por rango desde:' + anio_desde.toString() + '\n' + 'Mes por rango desde ' + mes_desde.toString() + '\n' + 'Año por rango hasta:' + anio_hasta.toString() + '\n' + 'Mes por rango hasta ' + mes_hasta.toString());
                    // console.log('1:2');
                }
            ...
            */
            ...
            if (anio !== "" && mes !== "") {
                ...
                popup_swal('No tiene los parametros suficientes');
        ...
        function Boto_cartera() {
            ...
            document.getElementById('respuesta').innerHTML = '';
            document.getElementById('frmbuscar').innerHTML = '';
            document.getElementById('sub_route_1').innerHTML = '/ ' + 'Informe categorizacion credito y cartera';
            // texto = texto + '<center>                                                                                                                                                                                       ';
            ...
            texto = texto + `
            <center>                                                                                                                                                                                       
                <a class="waves-efect waves-light btn #E67402 orange darken-1" onclick="Inf_Cre_Car();" style="text-transform: capitalize;font-weight: bold;" disabled>Informe general</a>&nbsp;&nbsp;&nbsp;   
        ...
        function Cedula_Cartera() {
            ...
            <div style="width: 200px; text-align: center;" class="#439049 green darken-1 white-text text-darken-2" style="font-size:1.5vw;text-align:center;color:white;">
                Ingrese No. De Cedula.
            </div>             
            <div class="input-field col s8" style="width: 200px;">                                                                                                                                                 
                <input id="Cedula" onkeyUp="return ValNumero(this);" placeholder="Cedula" maxlength="15" type="text" class="validate" style="background-color: white; font-size: 1.4em; text-align: center;"/>        
        ...
        function Portos() {
            ...
            document.getElementById('Carguesi').value = '';
            texto = '';
            // texto = texto + '<div class="flow-text gray" style="font-size:1.5vw;text-align:left; color: #439049;"><span  class="info_route">Portos / </span><b>INFORMES PORTOS <span id="sub_route" name ="sub_route">/</span>   </b></div>';
            texto = texto + '<div class="flow-text gray" style="font-size:1.5vw;text-align:left; color: #439049;"><span  class="info_route">Portos / </span><b>INFORMES PORTOS <span id="sub_route" name ="sub_route" class="info_route"> </span> <span id="sub_route_1" name ="sub_rout_1" class="info_route">  </span>   </b></div>';
        ...
        function Inf_Rec_CliP() {
            document.getElementById('sub_route').innerHTML = '/ Informe Reclamación Por Cliente';
            document.getElementById('sub_route_1').innerHTML = '';
            document.getElementById('parametros').innerHTML = '';
            document.getElementById('frmbuscar').innerHTML = '';
            //document.getElementById('cartera1').style.visibility='hidden';
            ...
            document.getElementById('frmbuscar').style.visibility = 'hidden';
            document.getElementById('Carguesi').value = 'Espere por favor....'; //.style.visibility='visible';
            document.getElementById('respuesta').style.visibility = 'visible';
            document.getElementById('estado').innerHTML = '<center><img src="img/escribe.gif" width="180px" height="180px"></center>';
            document.body.style.cursor = 'wait';
        ...
        function Inf_His_Com() {
            //var texto='';
            document.getElementById('sub_route').innerHTML = '/ Informe historialo de compras ';
            document.getElementById('sub_route_1').innerHTML = '';
            document.getElementById('frmbuscar').innerHTML = '';
            document.getElementById('Carguesi').value = 'Espere por favor....'; //.style.visibility='visible';
            document.getElementById('respuesta').style.visibility = 'visible';
        ...
        /* FIXME:_REPARA EL LLAMDO YA QUE NO MUSTRA EL CONTENIDO DE LOS FORMULARIOS */
        function buscarPqrP() {
            // texto = '';
            // document.getElementById('parametros').style.visibility = 'hidden';
            document.getElementById('sub_route').innerHTML = '/ pqr';
            document.getElementById('sub_route_1').innerHTML = '';
            document.getElementById('frmbuscar').style.visibility = 'visible';
            // document.getElementById('frmbuscar').innerHTML = '';
            document.getElementById('parametros').innerHTML = '';
            ...
            // formulario_control('consultar_informe', 'PQR', 'Pqr/Inf_Pqr_P', 'si', 'port');// se consulta al archivo directo de las consultas
            formulario_control('consultar_informe', 'PQR', 'Pqr/Inf_Pqr_General', 'si', 'port');
        }
        ...
        function Almacen() {
            ...
            document.getElementById('estado').innerHTML = '';
            texto = '';
            texto = texto + '<div class="flow-text gray" style="font-size:1.5vw;text-align:left; color: #439049;"><span class="info_route">Almacén / </span><b>INFORMES ALMACEN <span id="sub_route" name ="sub_route" class="info_route"> </span> <span id="sub_route_1" name ="sub_rout_1" class="info_route">  </span>  </b></div>';
            ...
            if ($verboton !== FALSE || $pasa == true) {
            ?>
                texto = texto + '<a class="waves-efect waves-light btn #E67402 orange darken-1" onclick="buscarDatosINVA();" disabled>INVENTARIO</a>&nbsp;&nbsp;&nbsp;';
            <?php
            }
            $verboton = strpos($btnSecu, '1B');
            if ($verboton !== FALSE || $pasa == true) {
            ?>
                texto = texto + '<a class="waves-efect waves-light btn #E67402 orange darken-1" onclick="buscarDatosProcesosA();" disabled >PROCESAMIENTO</a>&nbsp;&nbsp;&nbsp;';
            <?php
            }
            ...
            if ($verboton !== FALSE || $pasa == true) {
            ?>
                texto = texto + '<a class="waves-efect waves-light btn #E67402 orange darken-1" onclick="BusKist();" disabled >KITS</a>&nbsp;&nbsp;&nbsp;';
            <?php
            }
            ?>
        ...
        function Inf_Rec_Cli() {
            ...
            document.getElementById('sub_route').innerHTML = '/ Informe reclamacion por cliente';
            document.getElementById('sub_route_1').innerHTML = '';
            document.getElementById('frmbuscar').innerHTML = '';
            document.getElementById('Carguesi').value = 'Espere por favor....'; //.style.visibility='visible';
            document.getElementById('respuesta').style.visibility = 'visible';
        ...
        function buscarPqrA() {
            texto = '';
            document.getElementById('sub_route').innerHTML = '/ inventario';
            document.getElementById('sub_route_1').innerHTML = '/';
            document.getElementById('frmbuscar').innerHTML = '';
            document.getElementById('respuesta').innerHTML = '';
            document.getElementById('estado').innerHTML = ''
            // formulario_control('consultar_informe', 'PQR', 'Pqr/Inf_Pqr_A', 'si'); // CONSULTA ANTIGUA Y DIRECTA
            formulario_control('consultar_informe', 'PQR', 'Pqr/Inf_Pqr_General', 'si', 'alm');
            document.getElementById('parametros').innerHTML = texto;
        }
        ...
        function Pqr_a() {
            ...
            peticion_http.open('POST', 'Pqr/Inf_Pqr_General.php?i=' + ini + '&f=' + fin + '&p=' + pqr, true);
            peticion_http.send(null);
        ...
        function BusKist() {
            ...
            texto = texto + '<div class="input-field col s3" style="width:50%; float: left;">';
        ...
        */
        ...
        function Pqr_A() {
            ...
            //popup_swal('archivo:' + file1 + ' arvhivo:' + file2);

            return false;

            var obj = document.getElementById('files').files[0];
            //popup_swal('archivo:' + file1 + '-----' +var1);
            //return false;
        ...
        function BusKistA(Inicio, Fin, Kits) {
            ...
            //popup_swal("prueba inicial: "+inic+" final: "+fin+" kits: "+kitsB);
            if (kitsB == "") {
                popup_swal("Seleccione una opcion");
                return false;
            }
            //return false;
            // Obtener la instancia del objeto XMLHttpRequest
        ...
        function Fecha_ing_MerP() {
            ...
            texto = '';
            // document.getElementById('frmbuscar').innerHTML = '';
            document.getElementById('sub_route_1').innerHTML = '/ Ingreso mercancia';
            document.getElementById('respuesta').innerHTML = '';
            ...
            <div class="input-field col s3" style="width:70%;">                                                                                                                                              
                <br>
        ...
        function Orden_f() {
            ...
            document.getElementById('respuesta').style.visibility = 'visible';
            document.getElementById('respuesta').innerHTML = '';
            document.getElementById('sub_route_1').innerHTML = '/ Ordenes pendientes';
        ...
        function buscarDatosProcesosP() {
            document.getElementById('sub_route').innerHTML = '/procesamiento';
            document.getElementById('sub_route_1').innerHTML = '';
            document.getElementById('respuesta').style.visibility = 'visible';
            document.getElementById('respuesta').innerHTML = '';
            document.getElementById('frmbuscar').innerHTML = '';
            ...
            texto = `
            <center>                                                                                                                                                                                                                                           
                <a class="waves-efect waves-light btn #E67402 orange darken-1" onclick="buscarProcesoActualP();" style="text-transform: capitalize;font-weight: bold;" title="Aún no se define query para este modulo" disabled>Proce terminados hoy</a>&nbsp;&nbsp;        
                <a class="waves-efect waves-light btn #E67402 orange darken-1" onclick="buscarProcesoPendienteP();" style="text-transform: capitalize;font-weight: bold;"title="Aún no se define query para este modulo" disabled>Proce Pendientes hoy</a>&nbsp;&nbsp;      
        ...
        function Despachos() {
            ...
            document.getElementById('frmbuscar').innerHTML = '';
            texto = '';
            texto = texto + '<div class="flow-text #439049 green darken-1" style="width:50%; font-size:1.5vw;text-align:center;color:white;">Despachos</div>';
        ...
        function DespachosB() {
            ...
            var fin = document.getElementById('fin').value;
            if (ini == "") {
                popup_swal("Seleccione Fecha Inicial");
                return false;
            }
            if (fin == "") {
                popup_swal("Seleccione Fecha Final");
                return false;
            }
            document.getElementById('estado').innerHTML = '<center><img src="img/escribe.gif" width="180px" height="180px"></center>';
            document.body.style.cursor = 'wait';
 ...
 */
            texto = texto + `
                <center>
                <a class="waves-efect waves-light btn #E67402 orange darken-1" onclick="buscarProcesoActualA();" style="text-transform: capitalize;font-weight: bold;"  >Procesos terminados hoy</a>&nbsp;&nbsp;&nbsp;   
                <a class="waves-efect waves-light btn #E67402 orange darken-1" onclick="buscarProcesoPendienteA();" style="text-transform: capitalize;font-weight: bold;"  >Procesos Pendientes hoy</a>&nbsp;&nbsp;&nbsp;
                </center>
        ...
        function Busc_Produ() {
            document.getElementById('sub_route').innerHTML = '/busqueda producto';
            document.getElementById('sub_route_1').innerHTML = '';
            document.getElementById('respuesta').style.visibility = 'visible';
            document.getElementById('respuesta').innerHTML = '';
            document.getElementById('parametros').style.visibility = 'visible';
        ...
        <div style="width: 100%; text-align: center;" class="#439049 green darken-1 white-text text-darken-2" style="font-size:1.5vw;text-align:center;color:white;">
            Ingrese Producto.
        </div>                                                                                      
        <div class="input-field col s8" style="width: 200px;">                                                                                                                                                                                                                     
        ...
        function Admin() {
            ...
            texto = texto + '<div class="flow-text #439049 green darken-1" style="width:50%; font-size:1.5vw;text-align:center;color:white;">Usuario a Buscar</div>';
        ...
        function Salir() {
            // let msj = swal("Hasta pronto", "Cerro Sesión", "success");
            swal({
                    title: "Desea Salir?",
                    icon: "info",
                    buttons: true,
        ...
        function pop_up_confirmar() {
            ...
            if (confirmAction) {
                popup_swal("Siguiente");
            } else {
                popup_swal("Conacelado");
            }
        }
        ...
        function msjs() {
            /*
            swal(titulo, subtitulo, tipoDeMensaje)
            */
            //  swal("Error!", "Algo salió mal!", "error");
            swal("Hasta pronto", "Cerro Sesión", "success");
...
<body>
    ...
    <div class="container" style="width: 98%;">
        ...
        <div class="row #439049 green darken-1" style="padding: 5px;">
            ...
            <div class="col">
                <img class="responsive-img center " src="img/logoAG.png" style="width: 6em; " />
                &nbsp;&nbsp;
            </div>
            <label style="
                            font-size: medium; 
        ...
        <div class="row #F0F0F0 gray darken-1">
            <label style="float: right;"><?php echo '(' . $_SESSION['usuARio'] . ') ' . $_SESSION['nomu']; ?>&nbsp; <a href="javascript:Salir()">Salir</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
            <?php
            if ($pasa == true) {
            ?>
