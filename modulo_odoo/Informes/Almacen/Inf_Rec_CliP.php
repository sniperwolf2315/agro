...
//echo "dias: {$dia} <br>"."Fecha inicial: ".$feini."<br>"."fecha Fin: ".$fefin;
        ...
        <td><a href='Informexls/Inf_His_ComprasP.xlsx'class=\"z-depth-1 white-text text-darken-2\">Descargar</a><Strong></td>";
        $r=$r."</tr>";
...
//$r=$r."<p>Ordenes de Compra Pendientes.</p>";//Fecha Inicio: ".$feini." - hasta: ".$fefin.".
                ...
                $miruta='../Informexls/';
                $nombre_fichero = 'Inf_His_ComprasP';
                    ...
                    if(file_exists($mipath2)) {
                        ...
                        $objWorkSheet = $objPHPExcel->createSheet(0);
                            ...
                            //$objWorkSheet->setTitle("$i");
                                $objWorkSheet->setTitle('Inf_His_Compras_008');
