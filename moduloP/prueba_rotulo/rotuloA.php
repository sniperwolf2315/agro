...
<table border="1" class=" frm" style=" border: none; page-break-after: always;">
	...
	<tr>
		...
		<table class="frs">
			...
			<tr>
				<td>Telefono</td>
				<td class="frl"><?= $ti["TEL"]?>Cel <?= $ti["CEL"]?></td>
			</tr>
		</table>
		</td>
	</tr>
...
<table class=" frm" style=" border: none; page-break-after: always;" cellspacing="0">
	<tr>
		...
		<table class="frs" width="100%" cellspacing="0">
			<tr>
				<td style="width:100%; height: 8px;" >Direccion: <a class="frl"><b><?= $ti["DIR"]?></b></a></td>
				
			</tr>
			<tr>
				<td style="height: 10px">
					Cliente : <a class="frl"><?= $ti["CLI"]?></a> 
					C.C. <a class="frl"><?= $ti["CC"]?></a>
					Cel : <a class="frl"><?= $ti["CEL"]?></a>
				</td>
				
			</tr>
			<tr>
				<td style="height: 10px">Obs: <?= $ti["OBS"]?> <a class="frl"><b><?= $meses["$hoyM"].$hoy?></b></a> Piezas <a class="frl"><b><?= $i?></b></a> de <a class="frl"><b><?= $_GET[cajas]?></b></a> </td>
			</tr>
		</table>
		</td>
		...
		<? 
				...
				foreach($facs as $fac){
				$cont++;
				$facod["$cont"] ="<img height='100%' src='../../php-barcode/php/sample php/sample-gd.php?type=datamatrix&width=4&height=20&code=".trim($fac)."&angle=0&x=38&y=25&font=7' />";
				}
				?>
