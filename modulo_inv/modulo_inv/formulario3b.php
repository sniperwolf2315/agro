...
?>
                    ...
                    <input onblur="onKeyUp2(event,this.name)" type="text" class="texto1" id="T1" name="T1" maxlength="30" autofocus="true" autocomplete="off" />&nbsp;<input type="button" class="boton2" name="D" value="B" onclick="onKeyUp2(event,this.name)" /><br /><br />
                    ...
                    <input type="button" class="boton2" name="Buscades" value="B" onclick="consultarDatosNombre2();" /><br /><br />
                    ...
                    <input onblur="onKeyUp2(event,this.name)" type="number" class="texto1" id="T4" name="T4" onkeyUp="return ValNumero(this);" maxlength="4" style="width: 20%;" autocomplete="off" /><br /><br />
                    ...
                    <input type="button" class="boton4" name="Registrar" id="Registrarfrm" value="GUARDAR" onclick="registrarDatos();" /><br /><hr /><br /><br />
                    ...
                    <input type="button" class="boton3" name="Abandonar" id="Abandonar" value="SALIR" onclick="cerrarAplicacion();" /><br /><br />
