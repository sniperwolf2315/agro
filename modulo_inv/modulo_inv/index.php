...
<script language="JavaScript">
                ...
                function muestraContenido() {
                    if (peticion_http.readyState == 4) {
                        if (peticion_http.status == 200) {
                            ...
                            if (dato=='N'){
                                alert('Producto no pertenece a los grupos habilitados para conteo.');
            ...
            //CONSULTAR POR NOMBRE PRODUCTO
            function consultarDatosNombre() {
                var nombreprod=document.getElementById('Bdesc').value;
                if (nombreprod==''){
                    return false;
                }
                var nombre="";
                ...
                peticion_http.onreadystatechange = muestraContenido;
                // Realizar peticion HTTP
                peticion_http.open('POST', 'buscanomibs.php?nomp=' + nombreprod, true);
                peticion_http.send(null);
                    ...
                    if (peticion_http.readyState == 4) {
                        if (peticion_http.status == 200) {
                            ...
                            if (dato=='^') {
                                ...
                                document.getElementById('T2').value=nombre;
                                /*var i=0;
                                select = document.getElementById('T2x');
                                var opt=null;
                                ...
                                //document.getElementById('T2').value=dato;
                                document.getElementById('T3').value="S";
                                document.getElementById('item').value=item;
                                //document.getElementById('bodega').value=bodega;
                                document.getElementById('T1').value="";
            ...
            function consultarDatos2() {
                ...
                peticion_http.onreadystatechange = muestraContenido;
                // Realizar peticion HTTP
                peticion_http.open('POST', 'buscaitemibs2.php?itm=' + item, true);
                peticion_http.send(null);
            ...
            //CONSULTAR POR NOMBRE PRODUCTO
            function consultarDatosNombre2() {
                var nombreprod=document.getElementById('Bdesc').value;
                if (nombreprod==''){
                    return false;
                }
                ...
                peticion_http.onreadystatechange = muestraContenido;
                // Realizar peticion HTTP
                peticion_http.open('POST', 'buscanomibs2.php?nomp=' + nombreprod, true);
                peticion_http.send(null);
            ...
            function verificaGrupo2(Ip) {
                ...
                peticion_http.onreadystatechange = muestraContenido;
                // Realizar peticion HTTP
                peticion_http.open('POST', 'verificagrupoibs2.php?grp=' + grupo + '&fv=' + fvencimiento + '&gc=' + gconteo + '&sd=' + sede, true);
                peticion_http.send(null);
            ...
            function leernewItem(){
                ...
                document.getElementById('Registrarfrm').style.visibility='visible';
            }
             ...
             /*TECLA ENTER DETECT*/
              ...
              function registrarDatos(){
                    document.getElementById('Registrarfrm').style.visibility='hidden';
              ...
              function volverAplicacion(){
                    ...
                    peticion_http.onreadystatechange = muestraContenido;
                    // Realizar peticion HTTP
                    peticion_http.open('POST', 'volveraplicacion.php', true);
                    peticion_http.send(null);
              ...
              function Administra(){
                    document.getElementById('formularioadm').style.visibility='visible';
                    document.getElementById('Usuario').focus();
                    
              }
              
              function administrarAplicacion(){
                    ...
                    peticion_http.onreadystatechange = muestraContenido;
                    // Realizar peticion HTTP
                    peticion_http.open('POST', 'enviarusuario.php?u=' + usu + '&c=' + pwd, true);
                    peticion_http.send(null);
            ...
            function buscarporNombre(){
                document.getElementById('tbus').style.visibility='visible';
                document.getElementById('Bdesc').style.visibility='visible';
            ...
            function muestraFormulario(){
                ...
                if($Pantalla != '2'){
                    ...
                    var texto='<center><label class="e1">INVENTARIO1<br /> Sede:<span style="color: #FE7203;"> <? echo $sede; ?></span></label><br /><br />';
                    ...
                    texto=texto + '<select name="conteo" id="conteo" class="lista" onchange="leerGrupo();">';
                        ...
                        texto=texto + '<option value="0">1</option>';
                        texto=texto + '<option value="1">2</option>';
                        texto=texto + '<option value="2">3</option>';
                        texto=texto + '<option value="3">4</option>';
                        texto=texto + '<option value="4">5</option>';
                        texto=texto + '<option value="5">6</option>';
                    ...
                    var texto = '<center><label class="e1">INVENTARIO2<br /> Sede:<span style="color: #FE7203;"> <? echo $sede; ?></span></label></center><br /><br /><input type="button" class="boton4" name="Cambiar" value="LEER CODIGO" onclick="leernewItem();" />&nbsp;&nbsp;&nbsp;&nbsp;<label class="e1">Conteo:<span style="color: red;"> <? echo $conteo; ?></span></label><br />';
                    ...
                    var texto = '<center><label class="e1">INVENTARIO3 Sede:<span style="color: #FE7203;"> <? echo $sede; ?></span></label></center><br /><input type="button" class="boton4" name="Cambiar" value="LEER CODIGO" onclick="leernewItem();" />&nbsp;&nbsp;&nbsp;&nbsp;<label class="e1">Conteo: <span style="color: red;"><? echo $conteo; ?></span></label><br />';
                    texto=texto + '<input onkeyup="onKeyUp(event,this.name)" type="text" class="texto1" id="T1" name="T1" maxlength="30" autofocus="true" autocomplete="off" /><br /><br />';
                    texto=texto + '<label class="e1">Descripci&oacute;n:</label>&nbsp;&nbsp;&nbsp;';
                    texto=texto + '&nbsp;<textarea id="T2" name="T2" class="area" readonly="true"></textarea><br /><br />';
                    //texto=texto + '<input type="text" class="texto2" id="T2" name="T2" style="width: 200px;" readonly="true" /><br /><br />';
            ...
            function cerrarFormulario1(){
                    ...
                    peticion_http.onreadystatechange = muestraContenido;
                    // Realizar peticion HTTP
                    peticion_http.open('POST', 'cerrarFormulario1.php', true);
                    peticion_http.send(null);
...
<?php
                ...
                if($compania=='Agrocampo'){
                    ...
                    if($Pantalla == '0' || $Pantalla == ''){
                        ...
                        include('formulario1b.php');    
                    } else if($Pantalla=='2' && $fv=='0'){
                        include('formulario2b.php');    
                    } else if($Pantalla=='2' && $fv=='1'){
                        include('formulario3b.php');   
                    } else if($Pantalla == ''){
                       header("location:../index.php"); 
                    }
                }else if($Pantalla == ''){
