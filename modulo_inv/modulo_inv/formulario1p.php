...
?>
                    ...
                    <label class="e1">INVENTARIO <span style="color: #1636EE;"> <? echo $compania; echo "  ".$sede; ?></span></label><br /><? echo "<span style=\"color: #0C22D8; font-size: 1.3em;\">Usuario: <b>".$Us;?></span></b><br />
