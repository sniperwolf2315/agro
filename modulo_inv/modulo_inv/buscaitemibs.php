...
//$sql="SELECT * FROM AGR620CFAG.SROPRG SRBPRG LEFT JOIN AGR620CFAG.SROEAN SRBEAN ON SRBPRG.PGPRDC = SRBEAN.PJPRDC WHERE SRBEAN.PJEANP LIKE '%4540104902016%'";
                ...
                if($compania=='Agrocampo'){
                    ...
                    if($tam==13){
                        ...
                        $sql="SELECT * FROM AGR620CFAG.VISINVWHM WHERE PCXPRC='$codigotemp' OR LEFT(PCXPRC,12)='$codigotemp'";
                    }
                    if($tam==12 || $tam==11){
                        ...
                        $sql="SELECT * FROM AGR620CFAG.VISINVWHM WHERE PCXPRC='$codigotemp' OR LEFT(PCXPRC,12)='$codigotemp' OR LEFT(PCXPRC,11)='$codigotemp'";
                    }
