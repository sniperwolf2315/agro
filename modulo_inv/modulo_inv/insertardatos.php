<?php
    ...
    if($sede=='Portos'){
        ...
        if($compania=='Agrocampo'){
            $result = mssql_query("SELECT * from [sqlInventario008].[dbo].[invRegistro] WHERE pgprcd='$itm' and pgpgrp='$ubi' and FechaVencimiento='$fve' and Lote='$lot'");
        }else if($compania=='Comervet'){
            $result = mssql_query("SELECT * from [sqlInventarioComervet008].[dbo].[invRegistro] WHERE pgprcd='$itm' and pgpgrp='$ubi' and FechaVencimiento='$fve' and Lote='$lot'");
        }
        ...
        $grp=substr($ubi, -3);
        $result = mssql_query("SELECT * from [sqlInventario008].[dbo].[invRegistro] WHERE pgprcd='$itm' and pgpgrp='$grp'");
        $fila = mssql_fetch_array($result);
        $numero2 = mssql_num_rows($result);
    }
    ...
    if($numero2 == 0 ){
        if($compania=='Agrocampo'){
            if($con=='0'){
                $consulta2="INSERT INTO [sqlInventario008].[dbo].[invRegistro](pgprcd,pgpgrp,srsthq,fecha,cantidad1,cantidad2,cantidad3,cantidad4,cantidad5,canfac,Orden,NotaRecepcion,cansol,Descripcion,Procesado,FechaVencimiento,Lote,Historia)";
            ...
            if($con=='0'){
                $consulta2="INSERT INTO [sqlInventarioComervet008].[dbo].[invRegistro](pgprcd,pgpgrp,srsthq,fecha,cantidad1,cantidad2,cantidad3,cantidad4,cantidad5,canfac,Orden,NotaRecepcion,cansol,Descripcion,Procesado,FechaVencimiento,Lote,Historia)";
                $consulta2=$consulta2." VALUES('$itm','$ubi','$tot','$fecha','0','0','0','0','0','0','','$compania','0','$nom','','$fve','$lot','$Usuariolog')";
            }else if($con=='1'){
                $consulta2="INSERT INTO [sqlInventarioComervet008].[dbo].[invRegistro](pgprcd,pgpgrp,srsthq,fecha,cantidad1,cantidad2,cantidad3,cantidad4,cantidad5,canfac,Orden,NotaRecepcion,cansol,Descripcion,Procesado,FechaVencimiento,Lote,Historia)";
                $consulta2=$consulta2." VALUES('$itm','$ubi','0','$fecha','$tot','0','0','0','0','0','','$compania','0','$nom','','$fve','$lot','$Usuariolog')";
        ...
        if($compania=='Agrocampo'){
            if($con=='0'){
                $consulta2="UPDATE [sqlInventario008].[dbo].[invRegistro] SET srsthq='$tot', Historia='$Usuariolog' WHERE pgprcd='$itm' and pgpgrp='$ubi' and FechaVencimiento='$fve' and Lote='$lot'";
            }elseif($con=='1'){
                $consulta2="UPDATE [sqlInventario008].[dbo].[invRegistro] SET cantidad1='$tot', Historia='$Usuariolog' WHERE pgprcd='$itm' and pgpgrp='$ubi' and FechaVencimiento='$fve' and Lote='$lot'";
            }elseif($con=='2'){
                $consulta2="UPDATE [sqlInventario008].[dbo].[invRegistro] SET cantidad2='$tot', Historia='$Usuariolog' WHERE pgprcd='$itm' and pgpgrp='$ubi' and FechaVencimiento='$fve' and Lote='$lot'";
            }
        }else if($compania=='Comervet'){
            if($con=='0'){
                $consulta2="UPDATE [sqlInventarioComervet008].[dbo].[invRegistro] SET srsthq='$tot', Historia='$Usuariolog' WHERE pgprcd='$itm' and pgpgrp='$ubi' and FechaVencimiento='$fve' and Lote='$lot'";
            }elseif($con=='1'){
                $consulta2="UPDATE [sqlInventarioComervet008].[dbo].[invRegistro] SET cantidad1='$tot', Historia='$Usuariolog' WHERE pgprcd='$itm' and pgpgrp='$ubi' and FechaVencimiento='$fve' and Lote='$lot'";
            }elseif($con=='2'){
                $consulta2="UPDATE [sqlInventarioComervet008].[dbo].[invRegistro] SET cantidad2='$tot', Historia='$Usuariolog' WHERE pgprcd='$itm' and pgpgrp='$ubi' and FechaVencimiento='$fve' and Lote='$lot'";
            }
        }
        /*elseif($con=='3'){
    ...
    if($numero2 == 0 ){
        if($con=='0'){
            $consulta2="INSERT INTO [sqlInventario008].[dbo].[invRegistro](pgprcd,pgpgrp,srsthq,fecha,cantidad1,cantidad2,cantidad3,cantidad4,cantidad5)";
        ...
        if($con=='0'){
            $consulta2="UPDATE [sqlInventario008].[dbo].[invRegistro] SET srsthq='$tot' WHERE pgprcd='$itm' and pgpgrp='$grp'";
        }elseif($con=='1'){
            $consulta2="UPDATE [sqlInventario008].[dbo].[invRegistro] SET cantidad1='$tot' WHERE pgprcd='$itm' and pgpgrp='$grp'";
        }elseif($con=='2'){
            $consulta2="UPDATE [sqlInventario008].[dbo].[invRegistro] SET cantidad2='$tot' WHERE pgprcd='$itm' and pgpgrp='$grp'";
        }/*elseif($con=='3'){
