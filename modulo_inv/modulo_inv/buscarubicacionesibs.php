...
if (!isset($_SESSION)) { session_start(); }
            ...
            if ($tipobuscar=="XUbicacion"){
                $sql="SELECT * FROM AGR620CFAG.VISBODUBICA WHERE ID_UBICACION='$codigo' OR ID_UBICACION='$codigotemp' ORDER BY ID_UBICACION ASC";
            ...
            if ($tipobuscar=="XProducto"){
                ...
                if($tam==13){
                    ...
                    $sql="SELECT DISTINCT PGPRDC AS ITEM FROM AGR620CFAG.VISINVWHM WHERE PCXPRC='$codigotemp' OR LEFT(PCXPRC,12)='$codigotemp'";
                }
                if($tam==12 || $tam==11){
                    ...
                    $sql="SELECT DISTINCT PGPRDC AS ITEM FROM AGR620CFAG.VISINVWHM WHERE PCXPRC='$codigotemp' OR LEFT(PCXPRC,12)='$codigotemp' OR LEFT(PCXPRC,11)='$codigotemp'";
                }
    	        $result = odbc_exec($db2con, $sql);
                ...
                if($row = odbc_fetch_array($result)){
                    ...
                    //echo "--item---".$Itemdbar;                    //condulta datos de inventario DE BODEGA
                    $sql2="SELECT * FROM AGR620CFAG.VISBODUBICA WHERE ITEM='$Itemdbar' ORDER BY ID_UBICACION ASC";
            ...
            if ($tipobuscar=="XNombre"){
                $sql3="SELECT * FROM AGR620CFAG.VISBODUBICA WHERE DESCRIPCION LIKE '%$codigotemp%' ORDER BY ID_UBICACION ASC";
