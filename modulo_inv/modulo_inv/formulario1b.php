...
?>
                    ...
                    <label class="e1">INVENTARIOxx <span style="color: #1636EE;"> <? echo $compania; echo "  ".$sede; ?></span></label><br /><? echo "<span style=\"color: #0C22D8; font-size: 1.3em;\">Usuario: <b>".$Us;?></span></b><br />
                    ...
                    <tr style="height: 130px;"><td style="height: 50px;"></td><td><br /><input type="button" class="boton1" name="Iniciar" id="Iniciar" value="INICIAR" onfocus="verificaGrupo2('<? echo $sede; ?>');" onclick="verificaGrupo2('<? echo $sede; ?>');" /></td></tr></table>
                    <tr style="height: 130px;"><td style="height: 50px;"></td><td><br /><input type="button" class="boton3" name="Abandonar" id="Abandonar" value="CERRAR" onclick="cerrarAplicacion();" />&nbsp;&nbsp;&nbsp;
                    <?
