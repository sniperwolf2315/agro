...
require_once('user_con.php');
            $c=1;
            $concolor=1;
            // campos a mostrar en gestion de multiples facturas electronicas en col novedad
